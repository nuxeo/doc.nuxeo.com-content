...
| Channel | Version                                                                    |
| ------- | -------------------------------------------------------------------------- |
| Release | [5.2.4](https://community.nuxeo.com/static/drive-updates/release/?C=M;O=D) |
| Beta    |  |
| Alpha   | [5.2.5.x](https://community.nuxeo.com/static/drive-updates/alpha/?C=M;O=D) |
