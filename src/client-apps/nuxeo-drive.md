...
| Channel | Version                                                                    |
| ------- | -------------------------------------------------------------------------- |
| Release | [5.2.5](https://community.nuxeo.com/static/drive-updates/release/?C=M;O=D) |
| Beta    | [5.2.6](https://community.nuxeo.com/static/drive-updates/beta/?C=M;O=D)    |
| Alpha   | [5.2.7.x](https://community.nuxeo.com/static/drive-updates/alpha/?C=M;O=D) |
