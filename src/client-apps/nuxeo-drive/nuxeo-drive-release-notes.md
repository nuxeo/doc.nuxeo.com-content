...
Fixed Windows app startup issues, improved the Microsoft Windows installer so it now stops existing Drive instance before installing, resolved a Direct Transfer Web UI icon problem when target names contain spaces.
