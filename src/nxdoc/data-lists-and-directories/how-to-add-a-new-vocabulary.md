...
4.  Fill in the values like you want.
    ...
    Click on **Import CSV** to import content from a .csv file instead of typing each entry manually. See example files:[ simple vocabulary]({{file name='simple-vocabulary.csv' space='studio' page='vocabularies'}}) and [hierarchical vocabulary]({{file name='hierarchical-vocabulary.csv' space='studio' page='vocabularies'}}).
