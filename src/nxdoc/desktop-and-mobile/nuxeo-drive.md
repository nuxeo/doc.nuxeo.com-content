...
<tr>
<td colspan="1">![]({{file version='810' name='drive_offline.png' page='nuxeo-drive'}})</td>
<td colspan="1">Synchronization is disabled (offline mode or suspended synchronization).</td>
</tr>
<tr>
<td colspan="1">![]({{file version='810' name='drive_online.png' page='nuxeo-drive'}})</td>
<td colspan="1">Nuxeo Drive has successfully synchronized.</td>
</tr>
<tr>
<td colspan="1">![]({{file version='810' name='drive_transferring.png' page='nuxeo-drive'}})</td>
<td colspan="1">Nuxeo Drive is synchronizing with the Nuxeo Platform.</td>
</tr>
<tr>
<td colspan="1">![]({{file version='810' name='nuxeo_drive_systray_icon_stopping.png' page='nuxeo-drive'}})</td>
...
1.  Right-click on the icon ![]({{file version='810' name='drive_online.png' page='nuxeo-drive'}}) (in the top menu bar on Mac OS X, in the system tray on Windows).
2.  Click on the icon ![]({{file version='810' name='drive_open_drive_folder_icon.png' page='nuxeo-drive'}}).
...
To synchronize a space, in the Nuxeo Platform, click on the icon ![]({{file version='810' name='drive_unsynced-webui.png' page='nuxeo-drive'}} ?w=20).
The icon becomes ![]({{file version='810' name='drive_synced_under_root-webui.png' page='nuxeo-drive'}} ?w=20). Documents inside the synchronized space have a Drive local edit icon ![]({{file version='810' name='drive_edit-webui.png' page='nuxeo-drive'}} ?w=20).
...
To synchronize a space, in the Nuxeo Platform, click on the icon ![]({{file version='810' name='drive_unsynced.png' page='nuxeo-drive'}}).
...
![]({{file version='810' name='drive-synchronise-icon.png' page='nuxeo-drive'}} ?w=650,border=true)
...
![]({{file version='810' name='drive-newtab.png' page='nuxeo-drive'}} ?w=650,border=true)
...
2.  Click on the icon ![]({{file version='810' name='drive-settings-icon.png' page='nuxeo-drive'}}) and click on the **Suspend** menu item.
    If Nuxeo Drive is currently synchronizing, synchronization is completed before suspending Nuxeo Drive.
    The Drive icon becomes grey as long as synchronization is suspended: ![]({{file version='810' name='drive_offline.png' page='nuxeo-drive'}}).

**To resume synchronization:**

1.  Click on the Drive icon ![]({{file version='810' name='drive_offline.png' page='nuxeo-drive'}}) in the system tray.
2.  Click on the icon ![]({{file version='810' name='drive-settings-icon.png' page='nuxeo-drive'}}) and click on the **Resume** menu item.
...
Unsynchronizing a folder is only possible from the Nuxeo Platform web interface. You can only unsynchronize the whole synchronized space, i.e. from the synchronization root ![]({{file version='810' name='drive_synced_under_root-webui.png' page='nuxeo-drive'}} ?w=20).

To unsynchronize a space, in the Nuxeo Platform interface, click on the icon ![]({{file version='810' name='drive_synced_under_root-webui.png' page='nuxeo-drive'}} ?w=20).
...
Unsynchronizing a folder is only possible from the Nuxeo Platform web interface. You can only unsynchronize the whole synchronized space, i.e. from the synchronization root ![]({{file version='810' name='drive_synced.png' page='nuxeo-drive'}}): it is not possible to unsynchronize a child ![]({{file version='810' name='drive_synced_under_root.png' page='nuxeo-drive'}}). Clicking on the icon ![]({{file version='810' name='drive_synced_under_root.png' page='nuxeo-drive'}}) brings you back on the space from which the synchronization is done.

To unsynchronize a space, in the Nuxeo Platform interface, click on the icon ![]({{file version='810' name='drive_synced.png' page='nuxeo-drive'}}).
The icon becomes gray, indicating that the space is no longer synchronized. The folder and its content is no longer available from your Nuxeo Drive folder and from the Home **Nuxeo Drive** tab.
...
{{{multiexcerpt 'dnd-file-correspondence' version='810' page='creating-content'}}}
...
![]({{file version='810' name='drive-resolve-conflicts.png' page='nuxeo-drive'}} ?w=350,border=true)
...
Web UI: ![]({{file version='810' name='drive_edit-webui.png' page='nuxeo-drive'}} ?w=20)

JSF UI: ![]({{file version='810' name='drive_edit.png' page='nuxeo-drive'}})
...
3.  Click on Nuxeo Drive.
    ...
    ![]({{file version='810' name='Drive_metadata_view.png' page='nuxeo-drive'}} ?w=350,border=true)
4.  Click on **Edit** and modify your document,
    ![]({{file version='810' name='Drive_metadata_edit.png' page='nuxeo-drive'}} ?w=350,border=true)
5.  Click on **Save.**
