...
*   `TARGETDRIVEFOLDER`: The path to the Nuxeo Drive folder that will be created. Path must include the Nuxeo Drive folder. If `TARGETDRIVEFOLDER` is not specified then the default location will be picked.
