...
confluence:
    ...
    canonical: VCS
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/VCS'
    page_id: '28475493'
    shortlink: ZYCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/ZYCyAQ'
    source_link: /display/NXDOC710/VCS
history:
    - 
        author: Manon Lumeau
...
Some additional&nbsp;[explanations]({{page space='admindoc710' page='backup-and-restore'}})&nbsp;on why VCS ensures safe hot backups.
