...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Add+Complex+Fields+on+Your+Document+Type
    page_id: '22380587'
    shortlink: K4BVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/K4BVAQ'
    source_link: /display/NXDOC60/How+to+Add+Complex+Fields+on+Your+Document+Type
history:
    - 
        author: Solen Guitter
        date: '2016-03-02 09:10'
        message: ix screensho
        version: '19'
    - 
        author: Solen Guitter
...
3.  Add the different subfields and select their type.
    ![]({{file name='complex_field_editor_6.0.png'}} ?w=600,border=true)
4.  Click on **Save**.
...
1.  [Compose your layout]({{page space='studio' page='form-layouts'}}).
    The cell in which you dropped the complex field has an additional icon ![]({{file name='layout_table_subwidgets_edit.png' space='userdoc60' page='icons-index'}}).
...
3.  Click on the icon ![]({{file name='layout_table_subwidgets_edit.png' space='userdoc60' page='icons-index'}}) to edit the subfields widgets.
