...
toc: true
confluence:
    ajs-parent-page-id: '22380914'
    ajs-parent-page-title: Repository Concepts
    ajs-space-key: NXDOC60
    ajs-space-name: Nuxeo Platform Developer Documentation — 6.0
    canonical: Schema+Fields
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Schema+Fields'
    page_id: '22380902'
    shortlink: ZoFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/ZoFVAQ'
    source_link: /display/NXDOC60/Schema+Fields
history:
    - 
        author: Solen Guitter
        date: '2016-08-31 13:42'
        message: ''
        version: '3'
    - 
