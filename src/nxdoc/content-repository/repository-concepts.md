...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Repository+Concepts'
    page_id: '22380914'
    shortlink: coFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/coFVAQ'
    source_link: /display/NXDOC60/Repository+Concepts
tree_item_index: 100
history:
    -
...
![]({{file version='810' name='Selection_004.png'}} ?w=650,border=true)
...
![]({{file version='810' name='Selection_005.png'}} ?w=650,border=true)
...
![]({{file version='810' name='Selection_006.png'}} ?w=650,border=true)
