...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Versioning'
    page_id: '28475659'
    shortlink: C4GyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/C4GyAQ'
    source_link: /display/NXDOC710/Versioning
tree_item_index: 400
history:
    -
...
{{{multiexcerpt 'versioning' page='USERDOC710:Editing Content'}}}
...
For advanced uses, it's possible to plug in a new [`VersioningService`](http://community.nuxeo.com/api/nuxeo/7.10/javadoc/org/nuxeo/ecm/core/versioning/VersioningService.html) implementation to define what happens at creation, save, check in and check out time. See the [Javadoc](http://community.nuxeo.com/api/nuxeo/7.10/javadoc/org/nuxeo/ecm/core/versioning/VersioningService.html) and the [versioningService extension point](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-7.10/viewExtensionPoint/org.nuxeo.ecm.core.versioning.VersioningService--versioningService) documentation for more about this.
