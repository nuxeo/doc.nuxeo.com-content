...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC710/How+to+Enable+Add-Ons+Features+on+Custom+Document+Type
    page_id: '28475820'
    shortlink: rIGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/rIGyAQ'
    source_link: /display/NXDOC710/How+to+Enable+Add-Ons+Features+on+Custom+Document+Type
...
*   [Collections]({{page space='userdoc710' page='collections'}})
