...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Automatically+Convert+a+Document+to+PDF
    page_id: '22380710'
    shortlink: poBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/poBVAQ'
    source_link: /display/NXDOC60/How+to+Automatically+Convert+a+Document+to+PDF
history:
    - 
...
![]({{file name='screenshot_2011-08-30_15.40.09.png'}} ?border=true)
...
*   [Template Rendering Add-on]({{page space='userdoc60' page='template-rendering-addon'}})
