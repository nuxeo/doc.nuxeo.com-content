...
## <a name="customization-tab"></a>"How to Implement a New Type of Collection
...
*   Please be aware that all the limitations applied to [online editing with Nuxeo Drive](http://doc.nuxeo.com/display/USERDOC/Nuxeo+Drive#NuxeoDrive-OnlineEditing) apply to synchronized collections.
