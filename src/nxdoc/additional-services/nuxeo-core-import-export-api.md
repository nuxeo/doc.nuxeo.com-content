...
confluence:
    ...
    canonical: viewpage.action?pageId=28475451
    canonical_source: viewpage.action?pageId=28475451
    page_id: '28475451'
    shortlink: O4CyAQ
...
CoreIO default XML exports as bound using Restlet framework that is&nbsp;[still available](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-7.10/viewExtensionPoint/org.nuxeo.ecm.platform.ui.web.restAPI.service.PluggableRestletService--restlets)&nbsp;even if this has been superseded via JAX-RS.
