...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Using+CAS2+Authentication'
    page_id: '28475814'
    shortlink: poGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/poGyAQ'
    source_link: /display/NXDOC710/Using+CAS2+Authentication
tree_item_index: 712
history:
    -
...
It can be configured to use a CAS proxy. It has been tested and reported to work with CAS V2\. It is easy to test this plugin by installing the JA-SIG Central Authentication Service Open Source CAS server. To install the CAS2 authentication plugin:
...
You can see&nbsp;[specificChains](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-7.10/viewExtensionPoint/org.nuxeo.ecm.platform.ui.web.auth.service.PluggableAuthenticationService--specificChains) extension point for more info.
