...
### **Sitecore**
In the Modules/Settings you must add information related to your Nuxeo server.  As part of the configuration, you will need to give Sitecore information related to your Nuxeo instance. In Sitecore/System/Modules/Nuxeo Connector, click on **Standard Configuration** to expose the following settings:
...
You can enter any value you’d like here.  You will need to take this value and plug it into a [base64 encoding site] (https://www.base64encode.org/) to generate the base64 value that is used in your Nuxeo Sitecore SecretKey as described above.
**It's possible that you might already be using a jwt secret with Nuxeo.  If so, you can use the same value with Sitecore.**
