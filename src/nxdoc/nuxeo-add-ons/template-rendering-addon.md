...
![]({{file version='' page='template-rendering-addon' name='select_template.png'}} ?w=500,h=122,border=true)
...
- If the document has no template associated yet:
  1. Click on the icon ![]({{file version='' page='template-rendering-addon' name='doctemplate.png'}}).
  2. Select the template to use and click on **Bind template**.
    ![]({{file version='' page='template-rendering-addon' name='attach_template.png'}} ?w=397,h=381,border=true)
- If the document already has at least one associated template:
  ...
  3. Select the new template to associate with the document and click on the button **Bind template**.
    ...
    ![]({{file version='' page='template-rendering-addon' name='associated_template.png'}} ?w=250,h=138,border=true)
    It is also displayed in the **Associated template** tab.
    ![]({{file version='' page='template-rendering-addon' name='associated_template_tab.png'}} ?w=450,h=221,border=true)
...
1. Click on the **Publish** tab of the document.</br>
  An additional **Publish a rendition** drop down list is available beside the usual list of sections.
  ![]({{file version='' page='template-rendering-addon' name='publish_tab.png'}} ?w=450,h=160,border=true)
