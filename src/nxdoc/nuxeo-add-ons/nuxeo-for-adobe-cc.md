...
--}}
![university-adobe.png](/nx_assets/2c190506-8651-4546-a4bb-cab241c05378.png ?w=450,border=true)
{{/callout}}

## Requirements

Nuxeo for Adobe CC works with Adobe CC 2020 and 2021 and requires Nuxeo Platform 10.10 or newer, along with the appropriate Nuxeo for Adobe CC marketplace package installed on your Nuxeo instance.
...
{{!--     ### nx_asset ###
    ...
    addins#screenshot#up_to_date
--}}
![Adobe modify context path](/nx_assets/d8d0cedd-0054-49c8-9e52-1f3dddbec0e2.png)

Close the Preferences panel and continue with **To create your server listing.**
...
{{!--     ### nx_asset ###
    ...
    addins#popup#up_to_date
--}}
![Error no package installed](/nx_assets/bc366077-1ebf-43e3-9ecf-b50a0bfa3b36.png ?w=350,border=true)
{{/callout}}
...
{{!--     ### nx_asset ###
    ...
    addins#popup#up_to_date
--}}
![Adobe Other tab](/nx_assets/a11de8e1-2171-43ca-a63c-e3b55581b293.png ?w=350,border=true)
