...
2.  Install the [client side plugin](https://connect.nuxeo.com/nuxeo/site/marketplace/package/nuxeo-cc-connector-marketplace/associatedResource?reslabel=Adobe%20Plugin). It is available as a zip on the marketplace page. Unzip the client side plugin in the following location:
...
<iframe src="https://ext.prodpad.com/ext/roadmap/d0643a44cd1e962554922cc57e6d9f4da101ddbc" height="900" width="100%" frameborder="0"></iframe>
