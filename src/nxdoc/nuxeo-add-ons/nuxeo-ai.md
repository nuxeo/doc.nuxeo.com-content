...
# Extensions
Core AI is created with multiple extension points to the several processors.  The initial
release has:
* `nuxeo-ai-aws` package that allows us to connect to the Machine Learning services supplied by Amazon.
* `nuxeo-ai-image-quality` package that uses [Sightengine](https://sightengine.com/).
...
## Image Quality
An implementation of an enrichment service that uses [Sightengine](https://sightengine.com/). See the [GitHub Readme](https://github.com/nuxeo/nuxeo-ai/blob/master/addons/nuxeo-ai-image-quality-core/README.md#nuxeo-ai-image-quality) for additional technical details.
