...
description: By default, documents can be created in workspaces, templates and folders only. This section presents the different means that are available to you.
review:
    comment: ''
    date: '2019-10-18'
    status: ok
