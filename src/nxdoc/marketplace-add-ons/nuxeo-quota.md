...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Nuxeo+Quota'
    page_id: '22380728'
    shortlink: uIBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/uIBVAQ'
    source_link: /display/NXDOC60/Nuxeo+Quota
history:
    - 
        author: Anonymous
...
<span style="font-size: 10.0pt;line-height: 13.0pt;">More information on</span> [how versioning works]({{page space='userdoc60' page='editing-content#versioning-overview'}})<span style="font-size: 10.0pt;line-height: 13.0pt;">.
</span>
