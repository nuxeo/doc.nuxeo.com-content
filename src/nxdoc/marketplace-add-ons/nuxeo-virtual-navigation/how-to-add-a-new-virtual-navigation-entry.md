...
1.  [undefined](#make-sure-you-have-all-the-required-elements)
2.  [Configure the link and the query](#configure-the-virtual-navigation-query-and-link)
3.  [Configure the result layout](#configure-the-result-layout-of-your-virtual-navigation)
