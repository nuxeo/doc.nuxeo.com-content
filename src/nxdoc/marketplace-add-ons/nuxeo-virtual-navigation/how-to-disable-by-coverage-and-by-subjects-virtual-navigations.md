...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Disable+by+Coverage+and+by+Subjects+Virtual+Navigations
    page_id: '22380723'
    shortlink: s4BVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/s4BVAQ'
    source_link: >-
        /display/NXDOC60/How+to+Disable+by+Coverage+and+by+Subjects+Virtual+Navigations
history:
    - 
...
When disabling them for a Nuxeo version before 5.5, the following requirement is also needed to ensure that this contribution is loaded after the default ones:
...
When hiding them for a Nuxeo version before 5.5, the following requirement is also needed to ensure that this contribution is loaded after the default ones:
