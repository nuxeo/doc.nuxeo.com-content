...
{{{multiexcerpt 'drive-config-params' page='NXDOC:Nuxeo Drive Installation / Configuration'}}}

{{{multiexcerpt 'drive-config-audit-logs' page='NXDOC:Nuxeo Drive Installation / Configuration'}}}
