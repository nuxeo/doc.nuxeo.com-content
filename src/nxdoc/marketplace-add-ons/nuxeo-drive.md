...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Nuxeo+Drive'
    page_id: '22380815'
    shortlink: D4FVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/D4FVAQ'
    source_link: /display/NXDOC60/Nuxeo+Drive
history:
    - 
    ...
    - 
        author: Solen Guitter
        date: '2016-04-08 12:30'
        message: Update Configuration section and add contributor guide
        version: '128'
    - 
        author: Manon Lumeau
        date: '2016-03-21 16:43'
        message: ''
        version: '127'
    - 
        author: Manon Lumeau
        date: '2016-03-21 16:38'
    ...
    - 
        author: Manon Lumeau
        date: '2015-06-09 08:49'
        message: ''
        version: '124'
    - 
        author: Manon Lumeau
        date: '2015-06-09 08:48'
        message: ''
        version: '123'
    - 
        author: Manon Lumeau
    ...
    - 
        author: Manon Lumeau
        date: '2015-06-09 08:47'
        message: ''
        version: '121'
    - 
        author: Solen Guitter
        date: '2015-01-29 17:12'
        message: replace link to jenkins by latest release
        version: '120'
    - 
        author: Solen Guitter
        date: '2014-12-05 16:58'
        message: fix links
        version: '119'
    - 
...
---
This page is about Nuxeo Drive 2\. For versions 1.x see the page [Nuxeo Drive 1.x Dev Documentation]({{page page='nuxeo-drive-1x-dev-documentation'}}).
...
The&nbsp;[Nuxeo Drive package](https://connect.nuxeo.com/nuxeo/site/marketplace/package/nuxeo-drive)&nbsp;requires no specific installation steps. It can be installed like any other package&nbsp;[from the Marketplace or from the Admin Center]({{page space='admindoc60' page='installing-a-new-package-on-your-instance'}}).
