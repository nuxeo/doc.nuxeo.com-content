...
review:
    ...
    status: ok
confluence:
    ajs-parent-page-id: '22380861'
    ajs-parent-page-title: Digital Asset Management (DAM)
    ajs-space-key: NXDOC60
    ajs-space-name: Nuxeo Platform Developer Documentation — 6.0
    canonical: Supported+File+Formats
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Supported+File+Formats'
    page_id: '22380558'
    shortlink: DoBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/DoBVAQ'
    source_link: /display/NXDOC60/Supported+File+Formats
tree_item_index: 100
history:
    -
