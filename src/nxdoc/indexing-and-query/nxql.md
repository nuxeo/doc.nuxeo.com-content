...
confluence:
    ...
    canonical: NXQL
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/NXQL'
    page_id: '28475825'
    shortlink: sYGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/sYGyAQ'
    source_link: /display/NXDOC710/NXQL
history:
    - 
        author: Solen Guitter
        date: '2016-02-26 09:45'
        message: dd notes about MongoD
        version: '83'
    - 
...
## Complex Properties<a name="reference"></a>"
...
## <a name="nxql-examples"></a>"Examples
...
## <a name="MongoDBLimitations"></a>"Notes about MongoDB
...
## <a name="ElasticsearchLimitations"></a>"Notes about Elasticsearch
...
*   The&nbsp;`ecm:fulltext`&nbsp;matches the Elasticsearch&nbsp; `_all` &nbsp;field which is the concatenation of all fields. This is different from the NXQL&nbsp;`ecm:fulltext`&nbsp;which matches only some explicit fields. You can [adapt the mapping to exclude some fields]({{page space='admindoc710' page='elasticsearch-setup'}}).
