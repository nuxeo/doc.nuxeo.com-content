...
history:
    - 
        ...
        message: emove notion of  month and quarter because they are not real interva
        version: '23'
    - 
...
*   <a name="aggId"></a>" `aggregate_id` is the id of the aggregate. It is used when defining a widget for a given aggregate, see [Aggregate Widget Types]({{page page='aggregate-widget-types'}}).
...
## <a name="termsAgg"></a>"Terms Aggregate
...
## <a name="signTermsAgg"></a>"Significant Terms Aggregate
...
## <a name="rangeAgg"></a>"Range Aggregate
...
## <a name="dateRangeAgg"></a>"Date Range Aggregate
...
## <a name="histogramAgg"></a>"Histogram Aggregate
...
## 
<a name="dateHistogramAgg"></a>"Date Histogram Aggregate
