...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Layout+Definitions'
    page_id: '28475754'
    shortlink: aoGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/aoGyAQ'
    source_link: /display/NXDOC710/Layout+Definitions
history:
    - 
...
## <a name="listing-layout"></a>"Listing Layout Definition
