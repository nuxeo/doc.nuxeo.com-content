...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Custom+Widget+Types'
    page_id: '22380774'
    shortlink: 5oBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/5oBVAQ'
    source_link: /display/NXDOC60/Custom+Widget+Types
history:
    - 
    ...
    - 
        author: Manon Lumeau
        date: '2015-09-16 12:22'
        message: ''
        version: '24'
    - 
        author: Anahide Tchertchian
        date: '2014-12-09 13:58'
        message: 'NXDOC-427: link to 6.0 templates'
        version: '23'
    - 
        author: Anahide Tchertchian
        date: '2014-12-09 13:57'
...
*   Sample JSON export URLs:
    ...
    <div class="table-scroll"><table class="hover"><tbody><tr><td colspan="1">[http://demo.nuxeo.com/nuxeo/site/layout-manager/widget-types/widgetTypes/document](http://demo.nuxeo.com/nuxeo/site/layout-manager/widget-types/widgetTypes/document)</td><td colspan="1">

    All widget types with category "document"

    </td></tr><tr><td colspan="1">[http://demo.nuxeo.com/nuxeo/site/layout-manager/widget-types/widgetTypes/document?version=5.8](http://demo.nuxeo.com/nuxeo/site/layout-manager/widget-types/widgetTypes/document?version=5.8)</td><td colspan="1">

    All widget types with category "document", filtering widget types with a version strictly higher than 5.4.0

    </td></tr><tr><td colspan="1">[http://demo.nuxeo.com/nuxeo/site/layout-manager/widget-types/widgetTypes?categories=studio%20document&version=5.8](http://demo.nuxeo.com/nuxeo/site/layout-manager/widget-types/widgetTypes?categories=studio%20document&version=5.8)</td><td colspan="1">
...
*   The widget type property `dev_template` can also be used to specify a custom template when displaying this widget type in [dev mode]({{page space='nxdoc' page='how-to-activate-ui-development-mode'}}). The default template for widget type is [widget_dev_template.xhtml](https://github.com/nuxeo/nuxeo-jsf/blob/release-6.0/nuxeo-platform-forms-layout-client/src/main/resources/web/nuxeo.war/widgets/dev/widget_dev_template.xhtml), a sample custom dev template is [action_widget_type_dev_template.xhtml](https://github.com/nuxeo/nuxeo-jsf/blob/release-6.0/nuxeo-platform-actions-jsf/src/main/resources/web/nuxeo.war/widgets/actions/dev/action_widget_type_dev_template.xhtml).
