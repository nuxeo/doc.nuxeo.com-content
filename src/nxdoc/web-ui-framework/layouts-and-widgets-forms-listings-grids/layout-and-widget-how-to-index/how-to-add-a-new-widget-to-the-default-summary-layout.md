...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Add+a+New+Widget+to+the+Default+Summary+Layout
    page_id: '22380803'
    shortlink: A4FVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/A4FVAQ'
    source_link: /display/NXDOC60/How+to+Add+a+New+Widget+to+the+Default+Summary+Layout
history:
    - 
