...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Aggregate+Widget+Types'
    page_id: '28475612'
    shortlink: 3ICyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/3ICyAQ'
    source_link: /display/NXDOC710/Aggregate+Widget+Types
history:
    - 
        author: Solen Guitter
        date: '2016-03-04 13:27'
        message: pdate links label
        version: '13'
    - 
        author: Manon Lumeau
...
## <a name="userSpec"></a>"User Terms Aggregate Widget Types
...
## <a name="dirSpec"></a>"Directory Terms Aggregate Widget Types
...
## <a name="docSpec"></a>"Document Terms Aggregate Widget Types
...
## <a name="rangeSpec"></a>"Range Aggregate Widget Types
