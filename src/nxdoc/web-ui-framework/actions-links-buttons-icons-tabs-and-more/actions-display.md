...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Actions+Display'
    page_id: '22380847'
    shortlink: L4FVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/L4FVAQ'
    source_link: /display/NXDOC60/Actions+Display
history:
    - 
...
The available categories are listed below and can also be found by checking action contributions on [the explorer](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-6.0/viewExtensionPoint/org.nuxeo.ecm.platform.actions.ActionService--actions).
