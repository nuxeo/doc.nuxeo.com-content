...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Filters+and+Access+Controls'
    page_id: '22380808'
    shortlink: CIFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/CIFVAQ'
    source_link: /display/NXDOC60/Filters+and+Access+Controls
history:
    - 
    ...
    - 
        author: Anahide Tchertchian
        date: '2015-10-13 14:31'
        message: ''
        version: '11'
    - 
        author: Manon Lumeau
        date: '2015-09-16 12:35'
        message: ''
        version: '10'
    - 
        author: Manon Lumeau
...
Filters can be registered using their own [extension point](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-6.0/viewExtensionPoint/org.nuxeo.ecm.platform.actions.ActionService--filters), or registered implicitly when defining them inside of an action definition.
...
This also can be looked up in XHTML templates, calling Seam component [webActions](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-6.0/viewSeamComponent/seam:webActions) and using its default evaluation context:
