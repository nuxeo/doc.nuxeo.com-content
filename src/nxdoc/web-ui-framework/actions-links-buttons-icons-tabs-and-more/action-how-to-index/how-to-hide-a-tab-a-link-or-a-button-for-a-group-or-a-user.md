...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC710/How+to+Hide+a+Tab%2C+a+Link+or+a+Button+for+a+Group+or+a+User
    page_id: '28475628'
    shortlink: 7ICyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/7ICyAQ'
    source_link: >-
        /display/NXDOC710/How+to+Hide+a+Tab%2C+a+Link+or+a+Button+for+a+Group+or+a+User
history:
    - 
        author: Manon Lumeau
