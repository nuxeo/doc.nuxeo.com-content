...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Custom+Action+Types'
    page_id: '22380852'
    shortlink: NIFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/NIFVAQ'
    source_link: /display/NXDOC60/Custom+Action+Types
history:
    - 
...
[Default action templates](https://github.com/nuxeo/nuxeo-jsf/tree/release-6.0/nuxeo-platform-actions-jsf/src/main/resources/web/nuxeo.war/incl/action) can also be browsed for examples.
