...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Navigation+URLs'
    page_id: '28475775'
    shortlink: f4GyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/f4GyAQ'
    source_link: /display/NXDOC710/Navigation+URLs
history:
    - 
        author: Anonymous
...
Please refer to the [tag library documentation](http://community.nuxeo.com/api/nuxeo/7.10/tlddoc/nxd/restDocumentLink.html) for additional parameters: it's possible to set the tab, sub tab, and use a specific URL pattern.
