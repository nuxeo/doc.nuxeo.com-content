...
###### <a name="maxresults"></a>" maxResults elements
...
Note that when using an Elasticsearch page provider you can use [NXQL hints](https://doc.nuxeo.com/display/NXDOC710/NXQL#NXQL-ElasticsearchNXQLHints) inside predicates like this:
