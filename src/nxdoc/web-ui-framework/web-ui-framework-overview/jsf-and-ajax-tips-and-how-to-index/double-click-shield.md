...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Double+Click+Shield'
    page_id: '22380767'
    shortlink: 34BVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/34BVAQ'
    source_link: /display/NXDOC60/Double+Click+Shield
tree_item_index: 300
history:
    -
        author: Manon Lumeau
...
The "Double Click Shield" feature is enabled in the JSF interface and it addresses the issue described in "[I Get an Error When I Click on Two Links Quickly]({{page page='i-get-an-error-when-i-click-on-two-links-quickly'}})".
...
You can disable the shield for the whole Nuxeo application by adding the following&nbsp;parameter in your&nbsp;[nuxeo.conf file]({{page space='admindoc60' page='configuration-parameters-index-nuxeoconf'}}).
