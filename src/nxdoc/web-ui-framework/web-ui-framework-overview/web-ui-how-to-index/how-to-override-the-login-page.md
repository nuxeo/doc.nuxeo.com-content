...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/How+to+Override+the+Login+Page'
    page_id: '22380889'
    shortlink: WYFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/WYFVAQ'
    source_link: /display/NXDOC60/How+to+Override+the+Login+Page
history:
    - 
...
You will find more information related to the authentication here: [Authentication]({{page page='authentication'}}).
