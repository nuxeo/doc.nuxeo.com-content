...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/How+to+Customize+the+Dashboard'
    page_id: '28475631'
    shortlink: 74CyAQ
...
The extension defining the link **Dashboard** and the content of the tab is [<span class="componentTitle">org.nuxeo.ecm.user.center.dashboard.jsf.actions</span>](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-7.10/viewContribution/org.nuxeo.ecm.user.center.dashboard.jsf.actions--actions):
