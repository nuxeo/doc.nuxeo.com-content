...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Customize+the+Bulk+Import+Form
    page_id: '22380886'
    shortlink: VoFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/VoFVAQ'
    source_link: /display/NXDOC60/How+to+Customize+the+Bulk+Import+Form
history:
    - 
        author: Solen Guitter
        date: '2015-04-20 08:42'
        message: ix typ
        version: '27'
    - 
        author: Solen Guitter
        date: '2015-02-20 15:18'
        message: Add note about Where and Files fields
        version: '26'
    - 
        author: Manon Lumeau
        date: '2015-02-11 10:59'
        message: ''
        version: '25'
    - 
        author: Manon Lumeau
        date: '2015-02-10 14:21'
        message: ''
        version: '24'
    - 
        author: Manon Lumeau
...
![]({{file name='default_bulk_import.png' space='userdoc60' page='creating-content'}} ?w=500,border=true)
