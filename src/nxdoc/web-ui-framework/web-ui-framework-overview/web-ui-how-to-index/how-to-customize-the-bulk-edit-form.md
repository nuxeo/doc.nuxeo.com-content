...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Customize+the+Bulk+Edit+Form
    page_id: '22380888'
    shortlink: WIFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/WIFVAQ'
    source_link: /display/NXDOC60/How+to+Customize+the+Bulk+Edit+Form
history:
    - 
        author: Manon Lumeau
        date: '2015-09-16 12:06'
        message: ''
        version: '47'
    - 
        author: Manon Lumeau
        date: '2015-02-11 15:17'
        message: ''
        version: '46'
    - 
        author: Manon Lumeau
        date: '2015-02-10 14:27'
        message: ''
        version: '45'
    - 
        author: Manon Lumeau
...
This versioning policy can be configured through the&nbsp;[versioning](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-6.0/viewExtensionPoint/org.nuxeo.ecm.webapp.bulkedit.BulkEditService--versioning)&nbsp;extension point:
