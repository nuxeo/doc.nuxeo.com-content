...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Activate+UI+Development+Mode
    page_id: '22380830'
    shortlink: HoFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/HoFVAQ'
    source_link: /display/NXDOC60/How+to+Activate+UI+Development+Mode
history:
    - 
