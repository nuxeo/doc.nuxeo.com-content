...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Platform+as+a+Service'
    page_id: '22380845'
    shortlink: LYFVAQ
...
The first service we will introduce (Q4 2014/Q1 2015) is Nuxeo IDM for having a central User management service. The idea is to allow to manage all the users from one central location and simply assign them to the different nuxeo.io based applications.
