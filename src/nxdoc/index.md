...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Developer+Documentation+Center'
    page_id: '22380898'
    shortlink: YoFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/YoFVAQ'
    source_link: /display/NXDOC60/Developer+Documentation+Center
history:
    - 
        author: Solen Guitter
        date: '2014-12-09 10:27'
        message: pdate link to PD
        version: '81'
    - 
        author: Anonymous
...
![]({{file name='pdf-16.png' space='alldoc' page='nuxeo-downloadable-documentation'}} ?w=16,h=16) [Download this documentation in PDF]({{file name='Nuxeo_Platform_6.0_technical_documentation.pdf' space='alldoc' page='nuxeo-downloadable-documentation'}})
