...
history:
    ...
    -
        ...
        message: ''
        version: '1'
next_link: 810/nxdoc/getting-started-with-nuxeo-generator
...
*   Go to the next step of this quick start, so as to discover how you can contribute new features using Java code to the server.
