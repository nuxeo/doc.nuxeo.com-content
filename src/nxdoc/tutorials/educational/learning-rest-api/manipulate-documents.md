...
Check out the [Importing Files with the REST API](https://university.hyland.com/courses/e4138/importing-files-rest-api) video at [Hyland University](https://university.hyland.com/) for more information.
