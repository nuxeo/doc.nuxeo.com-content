...
[Learn more &rarr;]({{page space='NXDOC' page='Simple Workflow+Example'}})
{{/panel}}
...
[Learn more &rarr;]({{page space='NXDOC' page='Sub Workflow+Example'}})
{{/panel}}
</div>
...
[Learn more &rarr;]({{page space='NXDOC' page='Workflow Escalation+Rules+Example'}})
{{/panel}}
