...
We are going to [create an automation chain]({{page page='how-to-create-an-automation-chain'}}) to query on the Nuxeo repository and render the query result as a template-based CSV file.
...
The only step left is to [create a button]({{page page='how-to-create-an-automation-chain'}}) (**User Action** -> **New Action Feature**) that will trigger this operation chain.
