...
*   [ Drag & Drop ]({{page space='userdoc' page='creating-content'}})
...
*   [VCS Tables](https://doc.nuxeo.com/display/NXDOC/VCS+Tables)
*   [Examples of SQL Generated by VCS](https://doc.nuxeo.com/display/NXDOC/Examples+of++SQL+Generated+by+VCS)
*   [Java Data Structures and Caching](https://doc.nuxeo.com/display/NXDOC/Java+Data+Structures+and+Caching)
*   [Performance Recommendations](https://doc.nuxeo.com/display/NXDOC/Performance+Recommendations)
