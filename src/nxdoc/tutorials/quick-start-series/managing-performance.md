...
For simple and automatic GC (garbage collection in the JVM) monitoring, see the [Monitoring Page](http://doc.nuxeo.com/display/ADMINDOC/Monitoring+and+Maintenance?src=search#MonitoringandMaintenance-JVMGarbageCollector).
