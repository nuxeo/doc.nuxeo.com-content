...
*   [Oracle flight recording](https://doc.nuxeo.com/display/ADMINDOC/Reporting+problems#ReportingProblems-OracleJVMFlightRecording)
*   [Nuxeo Slow NXQL Queries]({{page page='monitoring-slow-nxql-queries'}})
*   [PostgreSQL monitoring](https://doc.nuxeo.com/display/ADMINDOC/Configuring+PostgreSQL)
