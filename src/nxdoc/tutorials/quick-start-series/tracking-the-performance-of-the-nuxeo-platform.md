...
Also to stress heavily the REST API [we use Gatling](https://github.com/nuxeo/nuxeo/tree/8.10/nuxeo-distribution/nuxeo-jsf-ui-gatling-tests).

We also use Nuxeo Platform addon tools like [`nuxeo-platform-importer`](https://github.com/nuxeo/nuxeo-platform-importer/blob/8.10/README.md) [](https://github.com/nuxeo/nuxeo-platform-importer/blob/8.10/README.md)to populate the document base.
