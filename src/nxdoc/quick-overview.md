...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Quick+Overview'
    page_id: '22380864'
    shortlink: QIFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/QIFVAQ'
    source_link: /display/NXDOC60/Quick+Overview
tree_item_index: 100
history:
    -
...
The default configuration for Nuxeo Repository is to use a SQL Database and a Filesystem storage:
...
For more details about Nuxeo Repository and BlobStore, please see the page [Binary Store]({{page page='binary-store'}}).
