...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Events+and+Listeners'
    page_id: '22380901'
    shortlink: ZYFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/ZYFVAQ'
    source_link: /display/NXDOC60/Events+and+Listeners
...
*   via Java API,
*   [via JMX]({{page space='admindoc60' page='supervision'}}).
