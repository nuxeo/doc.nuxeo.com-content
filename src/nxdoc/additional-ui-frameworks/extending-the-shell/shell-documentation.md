...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Shell+Documentation'
    page_id: '22380794'
    shortlink: _oBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/_oBVAQ'
    source_link: /display/NXDOC60/Shell+Documentation
history:
    - 
...
The generated documentation is available in both text format (for terminal) and wiki format. See [Nuxeo Shell Command Index]({{page space='admindoc60' page='nuxeo-shell-command-index'}}) for the wiki format.
...
When contributing new commands in the Nuxeo Shell core library (or modifying old ones) please make sure you update the wiki at [Nuxeo Shell Command Index]({{page space='admindoc60' page='nuxeo-shell-command-index'}}).
