...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC710/How+to+Modify+a+Workflow+Variable+outside+of+Workflow+Context
    page_id: '28475715'
    shortlink: Q4GyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/Q4GyAQ'
    source_link: >-
        /display/NXDOC710/How+to+Modify+a+Workflow+Variable+outside+of+Workflow+Context
history:
    - 
        author: Manon Lumeau
