...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Modify+a+Workflow+Variable+outside+of+Workflow+Context
    page_id: '22380697'
    shortlink: mYBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/mYBVAQ'
    source_link: >-
        /display/NXDOC60/How+to+Modify+a+Workflow+Variable+outside+of+Workflow+Context
history:
    - 
        author: Manon Lumeau
