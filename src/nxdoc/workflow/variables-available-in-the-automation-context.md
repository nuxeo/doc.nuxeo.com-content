...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/Variables+Available+in+the+Automation+Context
    page_id: '22380584'
    shortlink: KIBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/KIBVAQ'
    source_link: /display/NXDOC60/Variables+Available+in+the+Automation+Context
history:
    - 
