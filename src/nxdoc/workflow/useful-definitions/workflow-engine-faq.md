...
labels:
    ...
    - faq
confluence:
    ajs-parent-page-id: '28475810'
    ajs-parent-page-title: Useful Definitions
    ajs-space-key: NXDOC710
    ajs-space-name: Nuxeo Platform Developer Documentation — LTS 2015
    canonical: Workflow+engine+FAQ
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Workflow+engine+FAQ'
    page_id: '28475569'
    shortlink: sYCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/sYCyAQ'
    source_link: /display/NXDOC710/Workflow+engine+FAQ
history:
    - 
...
*   <a name="current-user-variable"></a>"**How can I get the current user name in an operation executed by the workflow?**
