...
The Nuxeo Platform provides an extensible and customizable marshalling service: [MarshallerRegistry](http://explorer.nuxeo.com/nuxeo/site/distribution/9.10/viewService/org.nuxeo.ecm.core.io.registry.MarshallerRegistry). This service allows you to use built-in marshallers but also to register your own
