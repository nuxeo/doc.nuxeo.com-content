---
title: OAuth 2 Resource Endpoint
description: A REST endpoint to retrieve OAuth 2 provider data.
review:
    comment: ''
    date: '2017-01-09'
    status: ok
  ...
  <table class="hover">
    <tbody>
      ...
      <tr>
        ...
        <td>Gets the list of registered OAuth&nbsp;2 service providers.</td>
      </tr>
      <tr>
        <td>POST `/api/v1/oauth2/provider`</td>
        <td>Creates a new OAuth&nbsp;2 service provider. Only available to Administrators.</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Updates an OAuth&nbsp;2 service provider. Only available to Administrators.</td>
      </tr>
      <tr>
        <td>DELETE `/api/v1/oauth2/provider/{providerName}`</td>
        <td>Deletes an OAuth&nbsp;2 service provider. Only available to Administrators.</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table class="hover">
    <tbody>
      ...
      <tr>
        ...
        <td colspan="1">The OAuth&nbsp;2 client ID.</td>
      </tr>
      <tr>
      <td colspan="1">`clientSecret`</td>
        <td colspan="1">The OAuth&nbsp;2 client secret.</td>
      </tr>
      <tr>
