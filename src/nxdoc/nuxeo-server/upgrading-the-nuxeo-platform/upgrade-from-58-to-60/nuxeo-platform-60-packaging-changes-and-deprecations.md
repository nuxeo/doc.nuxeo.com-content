...
For Nuxeo Platform 6.0, the DAM package has been simplified: it now holds the documents types Picture, Audio and Video. All the specific UI has been moved into the DAM compat addon (see the page&nbsp;[Nuxeo DAM Compat](http://doc.nuxeo.com/display/USERDOC/Nuxeo+DAM+Compat) for details).
