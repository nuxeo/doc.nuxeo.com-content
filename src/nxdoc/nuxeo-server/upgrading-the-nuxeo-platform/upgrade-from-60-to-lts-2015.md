...
Live Edit is no longer maintained. For office document offline editing, [Nuxeo Drive]({{page space='client-apps' page='nuxeo-drive'}}) provides a Direct Edit feature that enables users to edit files stored in the Nuxeo Platform using their native application.
