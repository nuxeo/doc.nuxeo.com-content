---
title: Security
description: A permission is a rule to grant access to a user or set of users to a Nuxeo document. In the dashboard users can see the documents on which a permission is set.
review:
    comment: ''
    date: '2017-12-14'
    status: ok
