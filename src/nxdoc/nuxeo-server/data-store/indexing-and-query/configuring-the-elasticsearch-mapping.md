...
description: This documentation page talks about the many aspects you can tune for improving the search experience for your users when it comes to searching the document repository index using one of Nuxeo Search Client OpenSearch package.
review:
    comment: ''
    date: '2017-12-13'
    status: ok
...
---
{{! excerpt}}
This documentation page talks about the many aspects you can tune for improving the search experience for your users when it comes to searching the document repository using an Elasticsearch or OpenSearch index.
{{! /excerpt}}
