...
description: Facets are markers on document types that instruct the Nuxeo platform to behave differently, or that are automatically set on some document instances.
review:
    comment: ''
    date: '2020-07-21'
    status: ok
