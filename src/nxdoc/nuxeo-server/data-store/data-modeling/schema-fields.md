...
Since Nuxeo 10.10-HF08 a property can be secured, in this case only Administrators can edit them. This prevents regular users to edit sensitive data.
...
Since Nuxeo 10.10-HF51, you can contribute indexes to be created at Nuxeo startup. Nuxeo supports these types of index: `ascending`, `descending`, and `none` to disable the index.
