...
description: Registering your Nuxeo application with Nuxeo Online Services let's you easily install patches, fix bugs, install addons from the Nuxeo Marketplace, or update.
review:
  comment: ''
  date: '2017-12-13'
  status: ok
