...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC/How+to+Estimate+Disk%2C+Database+and+Elasticsearch+Usage
    page_id: '7536973'
    shortlink: TQFz
    shortlink_source: 'https://doc.nuxeo.com/x/TQFz'
    source_link: /display/NXDOC/How+to+Estimate+Disk%2C+Database+and+Elasticsearch+Usage
history:
    - 
        author: Manon Lumeau
