...
Supported Java versions: {{! multiexcerpt name='java_requirement'}}**JDK 8** and **JDK 11** (Oracle's JDK or OpenJDK){{! /multiexcerpt}}.
...
<li>{{! multiexcerpt name='MongoDB-supported'}}MongoDB 3.4 and 4.2{{! /multiexcerpt}}</li>
