...
Redis can also serve as a centralized caching tool, allowing to share cache between Nuxeo server nodes for various data sources and thus preventing invalidation issues. You may refer to the [Nuxeo and Redis]({{page page='nuxeo-and-redis'}}) page for all details.
