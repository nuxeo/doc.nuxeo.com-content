...
`https://NUXEO_SERVER/nuxeo/api/v1/*`

This page explains the organisation and scope of the existing endpoints and other additional mechanisms which extend the behaviour of the API.
