...
CoreIO default XML exports as bound using Restlet framework that is [still available](http://explorer.nuxeo.org/nuxeo/site/distribution/latest/viewExtensionPoint/org.nuxeo.ecm.platform.ui.web.restAPI.service.PluggableRestletService--restlets) even if this has been superseded via Jakarta-RS.
