...
Workflow variables can be accessed from the automation context during the execution of the process using the context variable `WorkflowVariables["my_variable"]`. They can be updated using the Automation operation [Set Workflow Variable](https://explorer.nuxeo.com/nuxeo/site/distribution/latest/viewOperation/Context.SetWorkflowVar).
