 ...
 *
<p>
 * The module entry point is a regular Jakarta-RS resource named 'Sample1' and with an additional @WebModule annotation.
 ...
 *
<p>
 * A Web Module's Main resource is the entry point to the WebEngine model build over Jakarta-RS resources.
 * If you want to benefit of this model you should define such a module entry point rather than using plain Jakarta-RS resources.
 *
<p>
