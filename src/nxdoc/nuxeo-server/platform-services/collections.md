...
With this configuration you won't be able to unsynchronize a collection as usual using the ![]({{file name='drive-webui-synced-under-root.png' space='client-apps' page='nuxeo-drive'}}) icon as this icon will stay like this: ![]({{file name='drive-webui-unsynced.png' space='client-apps' page='nuxeo-drive'}}).</br>
