...
Server side, you should provide a [codec](https://explorer.nuxeo.com/nuxeo/site/distribution/10.10/viewExtensionPoint/org.nuxeo.ecm.automation.io.services.IOComponent--codecs). The implementation class is to be contributed to the automation server component using the `codecs` extension point.
