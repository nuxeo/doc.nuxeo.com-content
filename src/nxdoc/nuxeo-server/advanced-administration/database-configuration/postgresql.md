...
You shouldn't need to change this starting with Nuxeo 5.8, because two-phase commit isn't used in basic configurations.

However, if you've disabled single datasource ( <span>`nuxeo.db.singleDataSource=`) to use XA (see the&nbsp;[JDBC Datasource Configuration documentation]({{page page='jdbc-datasource-configuration'}}) for more on this), you will need to update</span>&nbsp;the default&nbsp;`max_prepared_transactions` settings. You can use the same value as `max_connections`.
...
CREATE OPERATOR CLASS _uuid_ops DEFAULT
   ...
   OPERATOR 3  <@(anyarray, 1="" 2="" 3="" 4="(anyarray," anyarray),="" OPERATOR="" FUNCTION="" uuid_cmp(uuid,="" uuid),="" ginarrayextract(anyarray,="" internal,="" internal),="" ginqueryarrayextract(anyarray,="" smallint,="" ginarrayconsistent(internal,="" anyarray,="" integer,="" STORAGE="" uuid;<="" code=""/>
```
