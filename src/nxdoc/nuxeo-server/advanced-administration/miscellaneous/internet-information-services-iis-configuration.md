...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC/Internet+Information+Services+%28IIS%29+Configuration
    page_id: '14256353'
    shortlink: 4YjZ
    shortlink_source: 'https://doc.nuxeo.com/x/4YjZ'
    source_link: /display/NXDOC/Internet+Information+Services+%28IIS%29+Configuration
history:
    -
        author: Manon Lumeau
...
6.  [Configure the server]({{page page='configuration-wizard'}}), but in General Settings, replace IP Address 0.0.0.0 by 127.0.0.1 to limit Tomcat to local answers.
