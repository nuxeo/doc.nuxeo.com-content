...
The source code of the Shibboleth authentication module can be found as part of the [`nuxeo-platform-login` addon on GitHub](https://github.com/nuxeo/nuxeo/tree/master/modules/platform/login).
