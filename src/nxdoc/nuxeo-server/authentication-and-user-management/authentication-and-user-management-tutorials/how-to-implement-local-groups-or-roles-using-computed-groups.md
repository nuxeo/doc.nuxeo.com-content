...
{{#> callout type='info' }}You should first have a quick first look to the [Javadoc of the ComputedGroupService](http://community.nuxeo.com/api/nuxeo/9.10/javadoc/org/nuxeo/ecm/platform/computedgroups/ComputedGroupsService.html) and the explorer.nuxeo.org documentation around this service ([computer](http://explorer.nuxeo.com/nuxeo/site/distribution/9.10/viewExtensionPoint/org.nuxeo.ecm.platform.computedgroups.ComputedGroupsServiceImpl--computer), [computerChain](http://explorer.nuxeo.com/nuxeo/site/distribution/9.10/viewExtensionPoint/org.nuxeo.ecm.platform.computedgroups.ComputedGroupsServiceImpl--computerChain)) and get back to it after having played this tutorial! {{/callout}}
