...
4.  Fill in the values as desired.
    ...
    Click on **Import CSV** to import content from a .csv file instead of typing each entry manually. See example files:[ simple-vocabulary.csv]({{file name='simple-vocabulary.csv' page='/studio/vocabularies'}}) and [hierarchical-vocabulary.csv]({{file name='hierarchical-vocabulary.csv' page='/nxdoc/vocabularies'}}).
