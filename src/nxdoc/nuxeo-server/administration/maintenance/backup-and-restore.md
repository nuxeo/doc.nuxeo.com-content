...
{{#> callout type='info' }}
Reminder: as stated in&nbsp;[Embedded Mode]({{page page='search-setup'}}#embedded-mode), the embedded Elasticsearch mode&nbsp;**is only for testing purpose**&nbsp;and should not be used in production.
