...
version_override:
    LTS 2025: /nxdoc/hotfixes-installation-notes-for-nuxeo-platform-lts-2025
...
Applications that query Relation documents must update queries to include them explicitly:

- Use `SELECT * FROM Document, Relation` to include both
