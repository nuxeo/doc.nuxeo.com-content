...
{{#> callout type='note' }}
Since Hotfix 37, hotfixes don't include any patch for the packages installed from the Nuxeo Marketplace. To also upgrade the installed Nuxeo packages, you need to run:
