...
Alternatively, you can rely on OpenSearch for full-text search and disable full-text indexing in the SQL database with `nuxeo.vcs.fulltext.search.disabled=true`.
