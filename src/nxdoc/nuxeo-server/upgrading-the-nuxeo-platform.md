...
6.  [Upgrade your Nuxeo Packages]({{page}}).
7.  [Upgrade and install your Studio project customization]({{page}}).
8.  [Upgrade and install your custom code]({{page}}).
...
The XML extensions contributed in Nuxeo Studio are not processed by the Studio upgrade compatibility checks. Follow the [custom code upgrade guidelines]({{page}}) to ensure they will work as expected.
...
If using the JBoss distribution, see [Upgrade to 5.4 and JBoss 5.]({{page}})
