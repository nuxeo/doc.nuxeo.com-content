...
Now you simply put your JAR in Nuxeo bundles directory (e.g. `$NUXEO_HOME/nxserver/bundles`) and your Web Application will be deployed under the URL: [http://localhost:8080/nuxeo/site](http://localhost:8080/nuxeo/site).
