...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/JSF+and+JavaScript'
    page_id: '28475765'
    shortlink: dYGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/dYGyAQ'
    source_link: /display/NXDOC710/JSF+and+JavaScript
tree_item_index: 400
history:
    -
...
- [JSF and Javascript ]({{page version='710' space='nxdoc' page='jsf-and-javascript'}})
