...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC58/Component+Model'
    page_id: '17334387'
    shortlink: c4AIAQ
    shortlink_source: 'https://doc.nuxeo.com/x/c4AIAQ'
    source_link: /display/NXDOC58/Component+Model
history:
    - 
        author: Arnaud Kervern
        date: '2016-08-16 09:40'
        message: ''
        version: '55'
    - 
        author: Arnaud Kervern
...
The list of existing services can be found on the [Nuxeo Platform Explorer](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-5.8/listServices).
...
The Nuxeo Platform uses extension points extensively, to let you extend and configure most of the features provided by the platform (see [all extension points available in the 5.8 version of the platform](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-5.8/listExtensionPoints) for instance).
