...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Creating+Nuxeo+Packages'
    page_id: '28475469'
    shortlink: TYCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/TYCyAQ'
    source_link: /display/NXDOC710/Creating+Nuxeo+Packages
history:
    - 
        author: Anonymous
...
*   **forms**&nbsp;- A directory containing custom wizard form definitions. This directory and all the files inside are optional.
    ...
    *   DEV mode is activated.
    ...
    Instead, you should use [a custom configuration template]({{page space='admindoc710' page='adding-custom-templates'}}) deployed and activated by the MP, then configured by the server administrator from&nbsp;`nuxeo.conf`.
