...
You can install directly from the [Chrome Web Store](https://chromewebstore.google.com/detail/nuxeo-dev-tools/hlpncekbnfimodgbhpldnhnnpgcoljml) or [Mozilla Addons](https://addons.mozilla.org/en-US/firefox/addon/nuxeo-dev-tools/).
