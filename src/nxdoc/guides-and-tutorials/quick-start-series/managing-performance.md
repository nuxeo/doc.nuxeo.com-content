...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Managing+Performance'
    page_id: '22380602'
    shortlink: OoBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/OoBVAQ'
    source_link: /display/NXDOC60/Managing+Performance
tree_item_index: 800
history:
    -
        author: Solen Guitter
        date: '2016-08-30 14:10'
        message: ''
        version: '15'
    -
        author: Manon Lumeau
        date: '2016-02-25 14:02'
        message: ''
        version: '14'
    -
        author: Solen Guitter
        date: '2016-02-16 09:50'
...
You can find more information about monitoring Nuxeo in the [Nuxeo Metrics page]({{page space='admindoc60' page='metrics-and-monitoring'}}).

For simple and automatic GC (garbage collection in the JVM) monitoring, see the [Monitoring Page]({{page version='60' space='admindoc' page='reporting-problems'}}#jvm-garbage-collector).
...
For more information on monitoring the Nuxeo Platform, please see [Nuxeo Metrics page]({{page space='admindoc60' page='metrics-and-monitoring'}}).
...
For more information about database-specific configurations and how to report problems, please see the [Database section]({{page space='admindoc60' page='database'}}).
...
- [How to Estimate Disk, Database and Elasticsearch Usage]({{page space='admindoc60' page='how-to-estimate-disk-database-and-elasticsearch-usage'}})
