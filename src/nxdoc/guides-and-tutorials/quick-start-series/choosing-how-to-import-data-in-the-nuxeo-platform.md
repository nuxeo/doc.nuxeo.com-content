...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/Choosing+How+to+Import+Data+in+the+Nuxeo+Platform
    page_id: '22380850'
    shortlink: MoFVAQ
...
{{#> panel heading='For more information'}}
- [VCS]({{page page='vcs'}})
- [Internal VCS Model]({{page space='NXDOC60' page='Internal VCS+Model'}})
- [VCS Tables]({{page space='NXDOC60' page='VCS Tables'}})
- [Examples of SQL Generated by VCS]({{page space='NXDOC60' page='Examples of++SQL+Generated+by+VCS'}})
- [Java Data Structures and Caching]({{page space='NXDOC60' page='Java Data+Structures+and+Caching'}})
- [Performance Recommendations]({{page space='NXDOC60' page='Performance Recommendations'}})
{{/panel}}
