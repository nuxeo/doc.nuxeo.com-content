...
*   [VCS]({{page page='vcs'}})
*   [Internal VCS Model](https://doc.nuxeo.com/display/NXDOC710/Internal+VCS+Model)
*   [VCS Tables](https://doc.nuxeo.com/display/NXDOC710/VCS+Tables)
*   [Examples of SQL Generated by VCS](https://doc.nuxeo.com/display/NXDOC710/Examples+of++SQL+Generated+by+VCS)
*   [Java Data Structures and Caching](https://doc.nuxeo.com/display/NXDOC710/Java+Data+Structures+and+Caching)
*   [Performance Recommendations](https://doc.nuxeo.com/display/NXDOC710/Performance+Recommendations)
