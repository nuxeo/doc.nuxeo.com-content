...
*   [Oracle flight recording](https://doc.nuxeo.com/display/ADMINDOC710/Reporting+problems#ReportingProblems-OracleJVMFlightRecording)
*   [Nuxeo Slow NXQL Queries]({{page space='admindoc710' page='monitoring-slow-nxql-queries'}})
*   [PostgreSQL monitoring](https://doc.nuxeo.com/display/ADMINDOC710/Configuring+PostgreSQL)
