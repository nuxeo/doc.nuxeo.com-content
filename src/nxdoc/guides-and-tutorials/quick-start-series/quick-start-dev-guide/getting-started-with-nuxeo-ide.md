...
1.  In Eclipse, click on the **Refresh** button in the **Nuxeo Server** view (![](http://doc.nuxeo.com/download/attachments/8684145/NxIDE_refresh_button.png?version=1&modificationDate=1317137136657&api=v2 ?w=16,h=17)).
