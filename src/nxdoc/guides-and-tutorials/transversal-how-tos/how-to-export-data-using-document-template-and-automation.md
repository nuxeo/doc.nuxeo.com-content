...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Export+Data+Using+Document+Template+and+Automation
    page_id: '22380692'
    shortlink: lIBVAQ
...
{{! /excerpt}}{{#> panel type='primary'}}

[Also check out the blog post Export Data with Content Automation.](http://blogs.nuxeo.com/development/2014/03/export-data-content-automation/)
