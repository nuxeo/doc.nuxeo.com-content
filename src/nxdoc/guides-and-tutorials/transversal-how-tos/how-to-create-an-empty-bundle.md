...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/How+to+create+an+empty+bundle'
    page_id: '22380667'
    shortlink: e4BVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/e4BVAQ'
    source_link: /display/NXDOC60/How+to+create+an+empty+bundle
history:
    - 
        author: Manon Lumeau
        date: '2016-08-17 12:21'
        message: ''
        version: '59'
    - 
        author: Manon Lumeau
        date: '2014-09-19 15:43'
