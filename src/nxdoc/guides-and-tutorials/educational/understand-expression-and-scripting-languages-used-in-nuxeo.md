...
<a name="schema-which-el"></a>" ![]({{file name='schema-which-el.png'}} ?w=500)
...
## <a name="what-expression-scripting-language-do-i-need-to-use"></a>"What Expression/Scripting Language do I Need to Use?
...
## <a name="available-variables-depending-on-context"></a>"Available Variables Depending on Context
