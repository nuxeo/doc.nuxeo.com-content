...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC710/Available+Variables+in+Email+Templates
    page_id: '28475606'
    shortlink: 1oCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/1oCyAQ'
    source_link: /display/NXDOC710/Available+Variables+in+Email+Templates
history:
    - 
...
*   `${Document}` **-** The context document. This is the document on which some action was done and the [send mail operation](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-7.10/viewOperation/Notification.SendMail) was triggered. See [Use of MVEL in Automation chains (document wrapper)]({{page page='use-of-mvel-in-automation-chains'}}) for details.
