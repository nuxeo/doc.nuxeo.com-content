...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC710/Validation+Workflow+Choosing+the+Assignee+Based+on+a+Metadata
    page_id: '28475641'
    shortlink: _YCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/_YCyAQ'
    source_link: >-
        /display/NXDOC710/Validation+Workflow+Choosing+the+Assignee+Based+on+a+Metadata
tree_item_index: 400
history:
    -
        author: Manon Lumeau
    ...
    -
        ...
        message: ''
        version: '1'
previous_link: 710/nxdoc/document-locking-right-after-its-creation
