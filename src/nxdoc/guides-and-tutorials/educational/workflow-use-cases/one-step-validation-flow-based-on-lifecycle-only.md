...
*   [Functional tour]({{page space='NXDOC710' page='Functional tour'}})
*   [Implement the validation logic]({{page space='NXDOC710' page='Implement the+validation+logic'}})
*   [Create a task assignment alert]({{page space='NXDOC710' page='Create a+task+assignment+alert'}})
*   [Create a button that triggers the task assignment]({{page space='NXDOC710' page='Create a+button+that+triggers+the+task+assignment'}})
