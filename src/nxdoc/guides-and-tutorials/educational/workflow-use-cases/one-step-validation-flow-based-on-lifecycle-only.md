...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC710/One+step+validation+flow+based+on+lifecycle+only
    page_id: '28475680'
    shortlink: IIGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/IIGyAQ'
    source_link: /display/NXDOC710/One+step+validation+flow+based+on+lifecycle+only
history:
    - 
        author: Manon Lumeau
...
*   [Functional tour](https://doc.nuxeo.com/display/NXDOC710/Functional+tour)
*   [Implement the validation logic](https://doc.nuxeo.com/display/NXDOC710/Implement+the+validation+logic)
*   [Create a task assignment alert](https://doc.nuxeo.com/display/NXDOC710/Create+a+task+assignment+alert)
*   [Create a button that triggers the task assignment](https://doc.nuxeo.com/display/NXDOC710/Create+a+button+that+triggers+the+task+assignment)