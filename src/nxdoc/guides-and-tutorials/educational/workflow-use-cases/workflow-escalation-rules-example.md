...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Workflow+Escalation+Rules+Example'
    page_id: '22380878'
    shortlink: ToFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/ToFVAQ'
    source_link: /display/NXDOC60/Workflow+Escalation+Rules+Example
history:
    - 
        author: Manon Lumeau
        date: '2014-12-10 16:43'
        message: ''
        version: '22'
    - 
...
We will take advantage of the escalation rules functionality introduced in Nuxeo 5.7.2.&nbsp;

Three escalation rules will be used:
