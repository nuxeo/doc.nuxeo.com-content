...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Deployment+Options'
    page_id: '28475525'
    shortlink: hYCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/hYCyAQ'
    source_link: /display/NXDOC710/Deployment+Options
history:
    - 
        author: Solen Guitter
        date: '2016-03-29 13:28'
        message: ix title capitalization and typo
        version: '39'
    - 
        author: Solen Guitter
...
For more information, please see the page [Setting up a HA Configuration Using the Nuxeo Platform and PostgreSQL]({{page space='admindoc710' page='setting-up-a-ha-configuration-using-the-nuxeo-platform-and-postgresql'}}).
...
![]({{file name='aws.png'}} ?w=500,h=320,border=true)
