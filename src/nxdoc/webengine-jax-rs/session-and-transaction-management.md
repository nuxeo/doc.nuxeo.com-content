...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Session+and+Transaction+Management'
    page_id: '22380871'
    shortlink: R4FVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/R4FVAQ'
    source_link: /display/NXDOC60/Session+and+Transaction+Management
history:
    - 
