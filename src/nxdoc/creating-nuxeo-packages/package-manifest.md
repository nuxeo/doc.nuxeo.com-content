...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Package+Manifest'
    page_id: '28475467'
    shortlink: S4CyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/S4CyAQ'
    source_link: /display/NXDOC710/Package+Manifest
history:
    - 
        author: Solen Guitter
        date: '2015-11-23 10:44'
        message: 'emove link to page "Creating Marketplace Packages", formattin'
        version: '20'
    - 
...
Versioning policy is free while it follows the pattern&nbsp;`major.minor.patch-classifier` described in [org.nuxeo.connect.update.Version](https://github.com/nuxeo/nuxeo-connect/blob/release-7.10/nuxeo-connect-client/src/main/java/org/nuxeo/connect/update/Version.java).
