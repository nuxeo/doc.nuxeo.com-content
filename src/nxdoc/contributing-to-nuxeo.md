...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC58/Contributing+to+Nuxeo'
    page_id: '17334332'
    shortlink: PIAIAQ
    shortlink_source: 'https://doc.nuxeo.com/x/PIAIAQ'
    source_link: /display/NXDOC58/Contributing+to+Nuxeo
history:
    - 
...
<span style="color: rgb(51,51,51);">Nuxeo labels are stored in ASCII files. We use the [UTF-8](http://www.utf8-chartable.de/) encoding for non ASCII files (like \<span class="x">u00e9</span> for &eacute;). You have two different options.</span> See [How to translate the Nuxeo Platform]({{page page='how-to-translate-the-nuxeo-platform'}}) for more details.

### <span style="color: rgb(51,51,51);">With Crowdin</span>

<span style="color: rgb(51,51,51);">Steps taken from the well written [Flattr translation guide](http://flattr.com/translation):</span>
...
4.  Enter the translation and by clicking &ldquo;commit translation&rdquo; commit it for approval/rating.

{{! /multiexcerpt}}

### Without Crowdin

1.  Fork [nuxeo-features/nuxeo-platform-lang](https://github.com/nuxeo/nuxeo-features/tree/release-5.8/nuxeo-platform-lang) (French and English) and [nuxeo-platform-lang-ext](https://github.com/nuxeo/nuxeo-platform-lang-ext) (all other languages) projects. See [How to translate the Nuxeo Platform]({{page page='how-to-translate-the-nuxeo-platform'}}) for more details.
2.  Use any standard Java i18n tool to edit the files (postfix it with the i18n code of the language you are translating).
3.  Create a contribution type ticket via [JIRA NXP ticket](http://jira.nuxeo.com/browse/NXP).
4.  Submit your path file attached to the JIRA issue or make a pull-request on [GitHub](https://github.com/nuxeo/).
5.  Optionally, send an email to <a>the nuxeo-dev mailing list with the subject "Labels contribution proposal"</a> or a post on&nbsp;[Nuxeo Answers](http://answers.nuxeo.com) or [the Nuxeo Google+ community](https://plus.google.com/communities/117410347547563540242).
...
2.  Get and read the user guide for the selected distribution and modules ([Nuxeo DM]({{page space='userdoc58' page='document-management'}}), [Nuxeo DAM]({{page space='userdoc58' page='digital-asset-management'}}), [Nuxeo CMF]({{page space='cmdoc55' page='nuxeo-cmf-55-user-guide'}})).
