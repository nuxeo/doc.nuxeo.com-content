...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Contributing+to+Nuxeo'
    page_id: '22380778'
    shortlink: 6oBVAQ
...
Steps taken from the well written [Flattr translation guide](http://flattr.com/translation):
...
1.  Fork [nuxeo-features/nuxeo-platform-lang](https://github.com/nuxeo/nuxeo-features/tree/release-6.0/nuxeo-platform-lang) (French and English) and [nuxeo-platform-lang-ext](https://github.com/nuxeo/nuxeo-platform-lang-ext) (all other languages) projects. See [How to translate the Nuxeo Platform]({{page page='how-to-translate-the-nuxeo-platform'}}) for more details.
...
2.  Get and read the [user guide]({{page space='userdoc60'}}) for the selected distribution and add-ons.
