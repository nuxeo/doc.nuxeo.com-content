...
#### <a name="RenderingContext-API-depth-aggregation"></a>"Controlling the Aggregation Depth
...
### <a name="aggregating-marshallers-infinite-loops"></a>"Aggregating Marshallers and Avoiding Infinite Loops
...
## <a name="document-JSON-extended-fields"></a>"Document JSON and Extended Fields
