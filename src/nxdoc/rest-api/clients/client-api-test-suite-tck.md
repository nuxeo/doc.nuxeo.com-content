...
confluence:
    ...
    canonical: viewpage.action?pageId=28475573
    canonical_source: viewpage.action?pageId=28475573
    page_id: '28475573'
    shortlink: tYCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/tYCyAQ'
    source_link: /pages/viewpage.action?pageId=28475573
history:
    - 
        author: Vladimir Pasquier
        date: '2016-01-06 20:08'
        message: ''
        version: '30'
    - 
        author: Manon Lumeau
...
[GitHub Link for CRUD operations tests suite](https://github.com/nuxeo/nuxeo-features/blob/release-7.10/nuxeo-automation/nuxeo-automation-test/src/test/java/org/nuxeo/ecm/automation/server/test/RemoteAutomationClientTCK.java#L81-L127)
...
[GitHub Link for Pagination operations tests suite](https://github.com/nuxeo/nuxeo-features/blob/release-7.10/nuxeo-automation/nuxeo-automation-test/src/test/java/org/nuxeo/ecm/automation/server/test/RemoteAutomationClientTCK.java#L129-L175)
...
[GitHub link for Blob operations tests suite](https://github.com/nuxeo/nuxeo-features/blob/release-7.10/nuxeo-automation/nuxeo-automation-test/src/test/java/org/nuxeo/ecm/automation/server/test/RemoteAutomationClientTCK.java#L177-L247)
...
[GitHub link for Complex Properties operations tests suite](https://github.com/nuxeo/nuxeo-features/blob/release-7.10/nuxeo-automation/nuxeo-automation-test/src/test/java/org/nuxeo/ecm/automation/server/test/RemoteAutomationClientTCK.java#L249-L295)
...
[GitHub link for Business Object operations tests suite](https://github.com/nuxeo/nuxeo-features/blob/release-7.10/nuxeo-automation/nuxeo-automation-test/src/test/java/org/nuxeo/ecm/automation/server/test/RemoteAutomationClientTCK.java#L297-L319)
...
[testCRUDSuite](https://github.com/nuxeo/nuxeo/blob/release-7.10/nuxeo-distribution/nuxeo-distribution-cap-webdriver-tests/src/test/java/org/nuxeo/ftest/caprest/ITRemoteAutomationClientTCK.java#L81-L127)

{{/callout}}</td><td colspan="1">{{#> callout type='tip' }}

[CRUD](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L8-L84)
...
[testPaginationSuite](https://github.com/nuxeo/nuxeo/blob/release-7.10/nuxeo-distribution/nuxeo-distribution-cap-webdriver-tests/src/test/java/org/nuxeo/ftest/caprest/ITRemoteAutomationClientTCK.java#L129-L175)

{{/callout}}</td><td colspan="1">{{#> callout type='tip' }}

[Pagination](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L86-L175)
...
[testBlobSuite](https://github.com/nuxeo/nuxeo/blob/release-7.10/nuxeo-distribution/nuxeo-distribution-cap-webdriver-tests/src/test/java/org/nuxeo/ftest/caprest/ITRemoteAutomationClientTCK.java#L177-L247)

{{/callout}}</td><td colspan="1">{{#> callout type='tip' }}

[Blob](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L86-L175) [Upload](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L177-L241)
...
[Blob](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L86-L175) [Upload Batch](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L243-L320)
...
[Blob](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L86-L175) [Update Batch](https://github.com/tiry/nuxeo-automation-jsshell/blob/release-7.10/src/main/resources/web/nuxeo.war/scripts/test/automation-tests.js#L366-L500)
...
[testComplexPropSuite](https://github.com/nuxeo/nuxeo/blob/release-7.10/nuxeo-distribution/nuxeo-distribution-cap-webdriver-tests/src/test/java/org/nuxeo/ftest/caprest/ITRemoteAutomationClientTCK.java#L249-L295)
...
[testBOSuite](https://github.com/nuxeo/nuxeo/blob/release-7.10/nuxeo-distribution/nuxeo-distribution-cap-webdriver-tests/src/test/java/org/nuxeo/ftest/caprest/ITRemoteAutomationClientTCK.java#L297-L319)
