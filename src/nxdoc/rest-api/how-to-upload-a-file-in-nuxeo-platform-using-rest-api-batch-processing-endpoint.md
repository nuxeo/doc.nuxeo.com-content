...
## <a name="BatchInitialization"></a>"Batch Initialization
...
## <a name="UploadingaFileinOneGo"></a>"Uploading a File in One Go (not Resumable)
...
## <a name="UploadingaFileinChunks"></a>"Uploading a File in Chunks (Resumable)
...
### <a name="UploadingChunkioutof5"></a>"Uploading Chunk i out of 5
...
### <a name="ResumeanInterruptedUpload"></a>"Resume an Interrupted Upload
