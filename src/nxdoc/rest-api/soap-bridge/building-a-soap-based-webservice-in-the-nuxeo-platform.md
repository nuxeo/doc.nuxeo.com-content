...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/Building+a+SOAP-Based+WebService+in+the+Nuxeo+Platform
    page_id: '22380661'
    shortlink: dYBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/dYBVAQ'
    source_link: /display/NXDOC60/Building+a+SOAP-Based+WebService+in+the+Nuxeo+Platform
history:
    - 
...
The code samples used for this example can be found [on GitHub](https://github.com/nuxeo/nuxeo-samples/tree/release-6.0/nuxeo-sample-webservice/nuxeo-sample-webservice-server).
