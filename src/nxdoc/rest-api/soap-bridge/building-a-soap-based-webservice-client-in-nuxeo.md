...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/Building+a+SOAP-Based+WebService+Client+in+Nuxeo
    page_id: '22380666'
    shortlink: eoBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/eoBVAQ'
    source_link: /display/NXDOC60/Building+a+SOAP-Based+WebService+Client+in+Nuxeo
history:
    - 
        author: Manon Lumeau
        date: '2015-09-16 11:36'
        message: ''
        version: '18'
    - 
...
The code samples used for this example can be found [here](https://github.com/nuxeo/nuxeo-samples/tree/release-6.0/nuxeo-sample-webservice/nuxeo-sample-webservice-client).
