...
### <a name="resources-endpoints"></a>"Resources Endpoints
...
### <a name="command-endpoints"></a>"Command Endpoint
...
## <a name="install-config"></a>"Installation and Configuration
...
### <a name="enable-batch-upload"></a>"Enabling Batch Upload
