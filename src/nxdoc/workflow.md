...
confluence:
    ...
    canonical: Workflow
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/Workflow'
    page_id: '28475714'
    shortlink: QoGyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/QoGyAQ'
    source_link: /display/NXDOC710/Workflow
history:
    - 
        author: Manon Lumeau
        date: '2016-08-17 11:49'
        message: ''
        version: '32'
    - 
        author: Manon Lumeau
        date: '2016-04-28 09:37'
...
They are also available as an application template in Nuxeo Studio so as to enable you to see how they are configured. This application template is called **<span style="color: rgb(67,67,67);">Default Nuxeo Platform Workflows Configuration</span>**.
