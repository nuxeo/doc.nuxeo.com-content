...
| affinity-3.0.5.jar |   | 3.0.5 | AL 2.0 |
...
| antisamy-1.5.3.jar | [AntiSamy](http://code.google.com/p/owaspantisamy/) | 1.5.3 | BSD 3 |
...
| automaton-1.11-8.jar |   | 1.11-8 | BSD 3 |
| aws-java-sdk-cloudfront-1.10.22.jar |   | 1.10.22 | AL 2.0 |
| aws-java-sdk-core-1.10.22.jar |   | 1.10.22 | AL 2.0 |
| aws-java-sdk-kms-1.10.22.jar |   | 1.10.22 | AL 2.0 |
| aws-java-sdk-s3-1.10.22.jar |   | 1.10.22 | AL 2.0 |
...
| box-java-sdk-2.2.2.jar |   | 2.2.2 | AL 2.0 |
...
| chronicle-bytes-1.7.16.jar |   | 1.7.16 | AL 2.0 |
| chronicle-core-1.7.6.jar |   | 1.7.6 | AL 2.0 |
| chronicle-queue-4.5.15.jar |   | 4.5.15 | AL 2.0 |
| chronicle-threads-1.7.2.jar |   | 1.7.2 | AL 2.0 |
| chronicle-wire-1.7.14.jar |   | 1.7.14 | AL 2.0 |
...
| com.noelios.restlet.ext.httpclient-1.0.7.jar |   | 1.0.7 | CDDL 1.0 |
| com.noelios.restlet.ext.servlet-1.0.7.jar | [Restlet](http://www.restlet.org) | 1.0.7 | CDDL 1.0 |
| commons-beanutils-1.9.2.jar | [Apache Commons BeanUtils](http://commons.apache.org/beanutils/) | 1.9.2 | AL 2.0 |
| commons-cli-1.3.1.jar |   | 1.3.1 | AL 2.0 |
| commons-codec-1.10.jar | [Apache Commons Codec](http://commons.apache.org/codec/) | 1.10 | AL 2.0 |
| commons-collections-3.2.2.jar | [Apache Commons Collections](http://commons.apache.org/collections/) | 3.2.2 | AL 2.0 |
| commons-csv-1.0.jar |   | 1.0 | AL 2.0 |
...
| commons-fileupload-1.3.1.jar | [Apache Commons FileUpload](http://commons.apache.org/fileupload/) | 1.3.1 | AL 2.0 |
| commons-httpclient-3.1.jar | [Apache Commons HttpClient](http://hc.apache.org/httpclient-3.x/) | 3.1 | AL 2.0 |
| commons-io-2.4.jar | [Apache Commons IO](http://commons.apache.org/io/) | 2.4 | AL 2.0 |
...
| commons-lang3-3.3.2.jar |   | 3.3.2 | AL 2.0 |
| commons-logging-1.1.jar |   | 1.1 | AL 2.0 |
| commons-pool-1.5.4.jar | [Apache Commons Pool](http://commons.apache.org/pool/) | 1.5.4 | AL 2.0 |
| commons-pool2-2.3.jar |   | 2.3 | AL 2.0 |
| commons-validator-1.5.1.jar |   | 1.5.1 | AL 2.0 |
| commons-vfs2-2.0.jar |   | 2.0 | AL 2.0 |
| compress-lzf-1.0.2.jar |   | 1.0.2 | AL 2.0 |
...
| cxf-core-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-bindings-soap-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-bindings-xml-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-databinding-jaxb-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-frontend-jaxws-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-frontend-simple-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-transports-http-3.1.3-NX2.jar |   | 3.1.3-NX2 | AL 2.0 |
| cxf-rt-ws-addr-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-ws-policy-3.1.3.jar |   | 3.1.3 | AL 2.0 |
| cxf-rt-wsdl-3.1.3.jar |   | 3.1.3 | AL 2.0 |
...
| el-api-1.0.jar |   | 1.0 | CDDL 1.0, GPL 2 |
| elasticsearch-2.3.5-nx1.jar |   | 2.3.5-nx1 | AL 2.0 |
| esapi-2.0.1.jar |   | 2.0.1 | BSD 3, CC BY-SA 3.0 |
| ezmorph-1.0.4.jar | [EZMorph](http://ezmorph.sourceforge.net/) | 1.0.4 | AL 2.0 |
| fluent-hc-4.5.2.jar |   | 4.5.2 | AL 2.0 |
...
| freemarker-2.3.23.jar |   | 2.3.23 | AL 2.0 |
| geronimo-annotation_1.0_spec-1.0.jar |   | 1.0 | AL 2.0 |
...
| groovy-all-2.4.0.jar | [Groovy](http://groovy.codehaus.org) | 2.4.0 | AL 2.0 |
...
| gwt-servlet-2.7.0-NX1.jar | [GWT](https://developers.google.com/web-toolkit/) | 2.7.0-NX1 | AL 2.0 |
| h2-1.4.177-NX01.jar |   | 1.4.177-NX01 | EPL 1.0, MPL 2.0 |
| HdrHistogram-2.1.6.jar |   | 2.1.6 | CC0 |
...
| howl-logger-0.1.11.jar |   | 0.1.11 | BSD 2 |
...
| httpclient-4.5.2.jar | [Apache HttpComponents](http://hc.apache.org) | 4.5.2 | AL 2.0 |
| httpclient-cache-4.5.2.jar |   | 4.5.2 | AL 2.0 |
| httpclient-osgi-4.5.2.jar |   | 4.5.2 | AL 2.0 |
| httpcore-4.4.4.jar | [Apache HttpComponents](http://hc.apache.org) | 4.4.4 | AL 2.0 |
| httpcore-nio-4.4.4.jar |   | 4.4.4 | AL 2.0 |
| httpcore-osgi-4.4.4.jar |   | 4.4.4 | AL 2.0 |
| httpmime-4.5.2.jar |   | 4.5.2 | AL 2.0 |
...
| jackson-databind-2.7.4.jar |   | 2.7.4 | AL 2.0 |
| jackson-dataformat-cbor-2.6.6.jar |   | 2.6.6 | AL 2.0 |
| jackson-dataformat-smile-2.6.6.jar |   | 2.6.6 | AL 2.0 |
| jackson-dataformat-yaml-2.6.6.jar |   | 2.6.6 | AL 2.0 |
| jackson-jaxrs-1.9.2.jar |   | 1.9.2 | AL 2.0 |
| jackson-mapper-asl-1.8.1.jar | [Jackson](http://jackson.codehaus.org) | 1.8.1 | AL 2.0 |
| jackson-xc-1.9.9.jar |   | 1.9.9 | AL 2.0 |
...
| javassist-3.20.0-GA.jar | [Javassist](http://www.jboss.org/javassist) | 3.20.0-GA | AL 2.0, LGPL 2.1, MPL 1.1 |
...
| jetty-6.1.26.jar | [Jetty](http://jetty.codehaus.org/jetty/) | 6.1.26 | AL 2.0, EPL 1.0 |
| jetty-annotations-6.1.26.jar |   | 6.1.26 | AL 2.0, EPL 1.0 |
| jetty-plus-6.1.26.jar |   | 6.1.26 | AL 2.0, EPL 1.0 |
| jetty-util-6.1.26.jar | [Jetty](http://jetty.codehaus.org/jetty/) | 6.1.26 | AL 2.0, EPL 1.0 |
...
| jna-4.1.0.jar |   | 4.1.0 | AL 2.0, LGPL 2.1 |
| jna-platform-4.1.0.jar |   | 4.1.0 | AL 2.0, LGPL 2.1 |
| joda-convert-1.2.jar |   | 1.2 | AL 2.0 |
...
| jotm-2.0.10.jar |   | 2.0.10 | BSD 2 |
| jotm_jrmp_stubs-2.0.10.jar |   | 2.0.10 | BSD 2 |
...
| jsp-api-2.2.jar |   | 2.2 | CDDL, GPLv2 with classpath exception |
| jsr166e-1.1.0.jar |   | 1.1.0 | CC0 1.0 Universal |
| jsr250-api-1.0.jar | [Common Annotations for Java (JSR 250)](http://jcp.org/en/jsr/detail?id=250) | 1.0 | CDDL 1.0 |
| jsr305-3.0.0.jar |   | 3.0.0 | AL 2.0 |
...
| jxls-core-1.0.jar |   | 1.0 | LGPL 2.1 |
| jxls-reader-1.0.jar |   | 1.0 | LGPL 2.1 |
...
| logback-classic-1.0.11.jar |   | 1.0.11 | EPL 1.0, LGPL 2.1 |
| logback-core-1.0.11.jar |   | 1.0.11 | EPL 1.0, LGPL 2.1 |
| lucene-analyzers-common-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-backward-codecs-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-core-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-grouping-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-highlighter-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-join-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-memory-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-misc-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-queries-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-queryparser-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-sandbox-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-spatial-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-spatial3d-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| lucene-suggest-5.5.0.jar |   | 5.5.0 | AL 2.0 |
| mail-1.4.5.jar |   | 1.4.5 | CDDL 1.0, GPL 2 CPE |
| marklogic-xcc-8.0.5.jar |   | 8.0.5 | AL 2.0 |
| maven-scm-api-1.4.jar |   | 1.4 | AL 2.0 |
| maven-scm-provider-svn-commons-1.4.jar |   | 1.4 | AL 2.0 |
| maven-scm-provider-svnexe-1.4.jar |   | 1.4 | AL 2.0 |
...
| mongo-java-driver-3.3.0.jar |   | 3.3.0 | AL 2.0 |
| mvel2-2.2.4.FinalNX01.jar | [MVEL](http://mvel.codehaus.org) | 2.2.4.FinalNX01 | AL 2.0 |
| mysql-connector-java-5.1.39.jar |   | 5.1.39 | GPL 2 |
| neethi-3.0.3.jar |   | 3.0.3 | AL 2.0 |
| nekohtml-1.9.22.jar | [NekoHTML](http://nekohtml.sourceforge.net) | 1.9.22 | AL 2.0 |
| netty-3.10.5.Final.jar |   | 3.10.5.Final | AL 2.0 |
...
| poi-3.10-FINAL.jar | [Apache POI](http://poi.apache.org) | 3.10-FINAL | AL 2.0 |
| poi-ooxml-3.10-FINAL.jar | [Apache POI](http://poi.apache.org) | 3.10-FINAL | AL 2.0 |
| poi-ooxml-schemas-3.10-FINAL.jar |   | 3.10-FINAL | AL 2.0 |
| poi-scratchpad-3.10-FINAL.jar | [Apache POI](http://poi.apache.org) | 3.10-FINAL | AL 2.0 |
...
| regexp-1.3.jar |   | 1.3 | AL 1.1 |
| relaxngDatatype-20020414.jar | [RELAX NG](http://sourceforge.net/projects/relaxng/) | 20020414 | BSD 3 |
| richfaces-4.5.12.Final.jar |   | 4.5.12.Final | LGPL 2.1 |
| richfaces-a4j-4.5.12.Final.jar |   | 4.5.12.Final | LGPL 2.1 |
| richfaces-core-4.5.12.Final.jar |   | 4.5.12.Final | LGPL 2.1 |
...
| securesm-1.0.jar |   | 1.0 | AL 2.0 |
| servlet-api-3.0.20100224.jar |   | 3.0.20100224 | AL 2.0, EPL 1.0 |
...
| t-digest-3.0.jar |   | 3.0 | AL 2.0 |
| tomcat-annotations-api-7.0.81.jar |   | 7.0.81 | AL 2.0 |
| tomcat-api-7.0.81.jar |   | 7.0.81 | AL 2.0 |
| tomcat-catalina-7.0.81.jar |   | 7.0.81 | AL 2.0 |
| tomcat-dbcp-7.0.81.jar |   | 7.0.81 | AL 2.0 |
| tomcat-jdbc-7.0.81.jar |   | 7.0.81 | AL 2.0 |
| tomcat-juli-7.0.81.jar |   | 7.0.81 | AL 2.0 |
...
| wsdl4j-1.6.3.jar |   | 1.6.3 | CPL 1.0 |
...
| xml-resolver-1.2.jar |   | 1.2 | AL 2.0 |
| xmlbeans-2.6.0.jar | [XMLBeans](http://xmlbeans.apache.org) | 2.6.0 | AL 2.0 |
| xmlschema-core-2.2.1.jar |   | 2.2.1 | AL 2.0 |
| xmlsec-1.5.6.jar |   | 1.5.6 | AL 2.0 |
| xmltooling-1.4.1.jar |   | 1.4.1 | AL 2.0 |
...
| xstream-1.4.9.jar | [XStream](http://xstream.codehaus.org) | 1.4.9 | BSD 3 |
