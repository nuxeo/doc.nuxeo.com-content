...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Content+Automation+Concepts'
    page_id: '22380718'
    shortlink: roBVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/roBVAQ'
    source_link: /display/NXDOC60/Content+Automation+Concepts
tree_item_index: 100
history:
    -
...
![A simple automation chain designed in Nuxeo Studio]({{file name='StudioAutomationSimpleChain.png'}} ?w=650,border=true 'A simple automation chain designed in Nuxeo Studio')
