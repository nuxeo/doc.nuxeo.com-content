...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC710/How+to+Create+an+Automation+Chain'
    page_id: '28475509'
    shortlink: dYCyAQ
    shortlink_source: 'https://doc.nuxeo.com/x/dYCyAQ'
    source_link: /display/NXDOC710/How+to+Create+an+Automation+Chain
history:
    - 
        author: Manon Lumeau
...
## Create an Automation Chain <a name="automation-chain-creation"></a>"
...
### Binding to an Action <a name="automation-chain-binding-button"></a>"
...
### Binding to an Event Handler <a name="automation-chain-binding-event-handler"></a>"
...
3.  In the **Event Handler Activation** section, fill in the filtering information, to target your event handler to the good context.
    ![]({{file name='NXS-event-handler-edition-form-2.png'}} ?w=350,border=true)
