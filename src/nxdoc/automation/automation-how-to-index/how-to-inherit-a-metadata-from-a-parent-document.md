...
version_override:
    ...
    'LTS 2016': 810/nxdoc/how-to-inherit-metadata-from-a-parent-document
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/NXDOC60/How+to+Inherit+a+Metadata+from+a+Parent+Document
    page_id: '22380884'
    shortlink: VIFVAQ
    shortlink_source: 'https://doc.nuxeo.com/x/VIFVAQ'
    source_link: /display/NXDOC60/How+to+Inherit+a+Metadata+from+a+Parent+Document
history:
    -
