...
{{{multiexcerpt 'web-ui-updates' page='web-ui-release-notes-3-1-13'}}}

---

## Previous Release Notes

<!-- | [Web UI 3.1.13]({{page page='web-ui-release-notes-3-1-13'}})                  | Package upgrade, Security and bugfix release     | -->
