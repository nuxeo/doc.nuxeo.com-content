...
- **Release Version**: Version 2025.14.0
- **Accessibility Conformance Report**: [Download the VPAT [here]({{file name='Nuxeo_Web_UI_VPAT_Version 2025.14.0.pdf'}})]
...
For more information, please refer to the [Accessibility Statement](https://doc.nuxeo.com/nxdoc/web-ui-accessibility-statement/) corresponding to release version LTS 2025 (version 2025.7.0) and the [Web UI release notes](https://doc.nuxeo.com/nxdoc/web-ui-release-notes/).