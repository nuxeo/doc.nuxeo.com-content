...
- After re-authentication, users are returned to the page they were previously viewing.
...
- Required multi-value properties now provide clearer validation feedback.
- Rendering issues affecting multi-value complex properties after editing have been resolved.
...
- Documents with unsupported file types now display a clear "No Preview Available" message instead of showing preview errors.
