---
title: Version 2025.7.0
description: Discover what's new in Web UI 2025.7.0.
review:
  comment: ''
  date: '2025-09-29'
  status: ok
...
## What’s New in Web UI for LTS 2025 (Version 2025.7.0)
...
- A workaround to refresh the page between drag and drop actions was introduced for the issue involving files being attached multiple times when using drag and drop in Web UI 2025.4.0 and higher.
