...
labels:
    - faq
confluence:
    ajs-parent-page-id: '17334466'
    ajs-parent-page-title: Useful Definitions
    ajs-space-key: NXDOC58
    ajs-space-name: 'Nuxeo Platform Developer Documentation - 5.8 '
    canonical: Workflow+engine+FAQ
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC58/Workflow+engine+FAQ'
    page_id: '17334528'
    shortlink: AIEIAQ
    shortlink_source: 'https://doc.nuxeo.com/x/AIEIAQ'
    source_link: /display/NXDOC58/Workflow+engine+FAQ
history:
    - 
