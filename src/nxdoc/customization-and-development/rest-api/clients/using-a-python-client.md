...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC58/Using+a+Python+Client'
    page_id: '17334504'
    shortlink: 6IAIAQ
    shortlink_source: 'https://doc.nuxeo.com/x/6IAIAQ'
    source_link: /display/NXDOC58/Using+a+Python+Client
history:
    - 
        author: Solen Guitter
        date: '2014-07-21 18:13'
