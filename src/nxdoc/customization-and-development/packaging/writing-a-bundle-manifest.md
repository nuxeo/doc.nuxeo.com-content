...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC58/Writing+a+bundle+manifest'
    page_id: '17334291'
    shortlink: E4AIAQ
    shortlink_source: 'https://doc.nuxeo.com/x/E4AIAQ'
    source_link: /display/NXDOC58/Writing+a+bundle+manifest
history:
    - 
...
You should first refer to the [Component Model page]({{page page='component-model'}}) for a better understanding of Nuxeo Runtime, Bundles, Components and services concepts.
