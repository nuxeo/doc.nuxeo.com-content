...
confluence:
    ...
    canonical: Nuxeo+Deployment+Model
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC58/Nuxeo+Deployment+Model'
    page_id: '17334527'
    shortlink: '-4AIAQ'
    shortlink_source: 'https://doc.nuxeo.com/x/-4AIAQ'
    source_link: /display/NXDOC58/Nuxeo+Deployment+Model
history:
    - 
...
[NuxeoCtl]({{page space='admindoc58' page='nuxeoctl-and-control-panel-usage'}}) is not really part of the deployment, but it's a central tool that helps managing Nuxeo Startup.
...
*   zip everything&nbsp;
    ![]({{file name='Nx-static-deploy.png'}} ?w=750,h=313,border=true)
