...
confluence:
    ...
    canonical: viewpage.action?pageId=17334372
    canonical_source: viewpage.action?pageId=17334372
    page_id: '17334372'
    shortlink: ZIAIAQ
    shortlink_source: 'https://doc.nuxeo.com/x/ZIAIAQ'
    source_link: /pages/viewpage.action?pageId=17334372
history:
    - 
        author: Solen Guitter
        date: '2015-11-24 09:23'
...
{{/callout}} {{#> callout type='note' heading='Compatibility Note'}}
...
Groovy support is not enabled by default. If you want to define web objects using Groovy you need to enable the &rsquo;groovy&rsquo; nature on the module. This is an example on how to do this:
