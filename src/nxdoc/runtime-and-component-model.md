...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Runtime+and+Component+Model'
    page_id: '22380900'
    shortlink: ZIFVAQ
...
The list of existing services can be found on the [Nuxeo Platform Explorer](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-6.0/listServices).
...
The Nuxeo Platform uses extension points extensively, to let you extend and configure most of the features provided by the platform (see [all extension points available in the platform](http://explorer.nuxeo.org/nuxeo/site/distribution/Nuxeo%20Platform-6.0/listExtensionPoints) for instance).
...
Now you may want to understand [how those packages are deployed on a Nuxeo server]({{page page='deployment-options'}}).
