...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/NXDOC60/Understanding+Bundles+Deployment'
    page_id: '22380566'
    shortlink: FoBVAQ
...
[NuxeoCtl]({{page space='admindoc60' page='nuxeoctl-and-control-panel-usage'}}) is not really part of the deployment, but it's a central tool that helps managing Nuxeo Startup.
...
*   [nuxeoctl and Control Panel Usage]({{page space='admindoc60' page='nuxeoctl-and-control-panel-usage'}})
