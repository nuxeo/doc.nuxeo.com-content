...
history:
    - 
        ...
        message: 'isspelling: extention -> extensio'
        version: '22'
    - 
...
## <a name="finding-extension-point"></a>"Finding the Extension Point Where to Contribute
...
## <a name="xml-extension-studio"></a>"Contributing Using Nuxeo Studio
