...
![Automation Scripting creation interface in Nuxeo Studio](/nx_assets/cef9980f-76db-4b31-b458-da446f1d174e.png ?w=350,border=true)
...
![Automation Script used for Text Classification](/nx_assets/6c9ff27a-9991-470d-8e13-b8a2e3b948ae.png ?w=650,border=true)
...
![Buttons configuration interface in Nuxeo Studio](/nx_assets/5868980f-39fb-4374-bed1-059ed3401465.png ?w=650,border=true)
...
![Use this Hot reload button from Dev tools to sync latest changes in Studio project](/nx_assets/002a1841-fecb-467e-ae34-82de50b78551.png ?w=550,border=true)
...
5. **Execute Action:** Navigate to an uploaded document (PDF/Docx for text, JPG/JPEG for images) and click the respective custom button (for example, `Classify Text` or `Describe Image`).
   ...
   ![Click the action buttons on a document](/nx_assets/c216a813-4089-49c6-a614-5a87330464d5.png ?w=350,border=true)
