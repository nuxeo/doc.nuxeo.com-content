...
**Generate JSON File:**
Click on the "Generate JSON File" button in your Studio project and follow the official documentation to add the contribution.
![]({{file name='Search-Mapping-JSON-Button.png'}} ?w=600,border=true)
