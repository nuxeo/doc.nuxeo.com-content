...
- **Document Facets**: Read the page [Available Facets]({{page space='nxdoc' page='available-facets'}}) for better understanding of what facets are and which ones are available. If you don't find the facet you are looking for, you can create it [using the Facet editor]({{page page='facets'}}) or reference an external one [using the custom facet registries]({{page page='registries'}}).
