...
Using Naming Conventions enables you to debug more efficiently. By investigating `server.log`, you can instantly identify which type of configuration caused an error. You can also link related content such as an event handler calling an automation chain more easily.
