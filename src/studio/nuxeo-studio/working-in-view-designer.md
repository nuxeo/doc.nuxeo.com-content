...
- [HOWTO: Define a New Document Type Layout in View Designer]({{page space='nxdoc' page='web-ui-document-layouts'}}#how-to-define-a-new-document-type-layout-with-the-view-designer)
- [HOWTO: Create a New Search Screen in View Designer]({{page space='nxdoc' page='web-ui-search'}}#how-to-create-a-new-search-screen-in-view-designer)
