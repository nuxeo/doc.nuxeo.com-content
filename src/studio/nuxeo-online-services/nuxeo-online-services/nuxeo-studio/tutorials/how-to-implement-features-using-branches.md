...
2.  Install the release&nbsp;[like you would install a Nuxeo Package](https://doc.nuxeo.com/display/ADMINDOC/Installing+a+New+Package+on+Your+Instance)&nbsp;and restart.
