...
*   Run [nuxeo-packaging-ondemand](https://qa.nuxeo.org/jenkins/job/nuxeo-packaging-ondemand/) to generate the OS-specific installers and the Virtual Machine packages.
