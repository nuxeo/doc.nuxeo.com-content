...
An ordered folder has the same presentation as a regular folder, but it has some additional buttons that you can access from the actions bar when the items are selected:
