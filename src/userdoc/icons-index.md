...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/USERDOC58/Icons+Index'
    page_id: '16092586'
    shortlink: qo31
    shortlink_source: 'https://doc.nuxeo.com/x/qo31'
    source_link: /display/USERDOC58/Icons+Index
history:
    - 
        author: Solen Guitter
        date: '2013-11-04 19:00'
        message: dded some Social Collaboration icons
        version: '17'
    - 
        author: Solen Guitter
...
</td></tr><tr><td colspan="1">![]({{file name='delete.png'}})</td><td colspan="1">
...
</td></tr><tr><td colspan="1">![]({{file name='annotate.png'}})</td><td colspan="1">
