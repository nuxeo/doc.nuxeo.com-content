...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/USERDOC60/Icons+Index'
    page_id: '21299446'
    shortlink: 9gBFAQ
    shortlink_source: 'https://doc.nuxeo.com/x/9gBFAQ'
    source_link: /display/USERDOC60/Icons+Index
history:
    - 
...
---
This page references the icons used in the Nuxeo Platform and their use.
...
Click to add the current document to the [worklist]({{page page='copying-and-moving-documents'}}).

</td></tr><tr><td colspan="1">![]({{file name='export.png'}})</td><td colspan="1">

Export options icons.

Click to see the different export options on the document.
...
Click to move selected item(s) down in the list.
...
<table><tbody><tr><th colspan="1">Icon</th><th colspan="1">Description</th></tr><tr><td colspan="1">![]({{file name='facetedSearch.png'}})</td><td colspan="1">Faceted search tab icon.</td></tr></tbody></table>
...
<table><tbody><tr><th colspan="1">Icon</th><th colspan="1">Description</th></tr><tr><td colspan="1">![]({{file name='byCoverageNavigation.png'}})</td><td colspan="1">Coverage virtual navigation tab icon.</td></tr><tr><td colspan="1">![]({{file name='bySubjectsNavigation.png'}})</td><td colspan="1">Subject virtual navigation tab icon.</td></tr></tbody></table>