...
*   The [Token Authentication](https://github.com/nuxeo/nuxeo/tree/10.10/nuxeo-services/login/nuxeo-platform-login-token) must be included in the authentication chain. 
