...
*   [relations actions]({{page space='USERDOC710' page='Editing Content#EditingContent-relations'}})
*   [preview]({{page space='USERDOC710' page='Preview'}})
*   [tagging]({{page space='USERDOC710' page='Tags'}})
*   [alerts]({{page space='USERDOC' page='Collaborative Features#CollaborativeFeatures-alertsAlerts'}})
...
When they click on the **Publish** tab of documents to publish a document, only the selected sections are available to publish the document. To **remove a section** from the workspace targets, click on&nbsp;![]({{file name='delete.png' space='userdoc' page='icons-index'}}) next to it.
