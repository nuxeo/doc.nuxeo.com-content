...
<div class="table-scroll"><table class="hover"><tbody><tr><td colspan="1">![]({{file name='orange-cloud.png' page='icons-index'}} ?w=30)</td><td colspan="1">Go to the local folders</td></tr><tr><td colspan="1">![]({{file name='grey-cloud.png' page='icons-index'}})</td><td colspan="1">Synchronization in progress</td></tr><tr><td colspan="1">![]({{file name='nuxeo_drive_systray_icon_stopping.png' page='nuxeo-drive-1x'}} ?w=25)</td><td colspan="1">Update all your folders</td></tr><tr><td colspan="1">![]({{file name='folder-info-icon.png' page='icons-index'}} ?w=25)</td><td colspan="1">See the local folder menu.</td></tr><tr><td colspan="1">![]({{file name='folder-update-icon.png'}} ?w=25)</td><td colspan="1">
...
When you [delete documents from the Platform]({{page page='Deleting Content'}}), they are deleted from your local Nuxeo Drive Mobile folder on your application at the next update.
