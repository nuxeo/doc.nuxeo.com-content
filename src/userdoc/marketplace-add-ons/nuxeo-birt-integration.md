...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/USERDOC58/Nuxeo+-+BIRT+Integration'
    page_id: '16092606'
    shortlink: vo31
    shortlink_source: 'https://doc.nuxeo.com/x/vo31'
    source_link: /display/USERDOC58/Nuxeo+-+BIRT+Integration
history:
    - 
        author: Solen Guitter
        date: '2016-08-31 15:22'
        message: ''
        version: '8'
    - 
        author: Solen Guitter
        date: '2014-07-29 09:58'
        message: ''
        version: '7'
    - 
        author: Solen Guitter
    ...
    - 
        author: Solen Guitter
        date: '2013-11-19 17:29'
        message: Removed related topics from TOC and updated screenshots
        version: '5'
    - 
        author: Solen Guitter
...
2.  Fill in the form (see below for more information on the different fields available).
    ![]({{file name='BIRT_model_creation.png'}} ?w=450,border=true)
3.  Click **Save**.
...
The access rights on report models are managed the same way as on any other space. You can report to the [Access rights management page]({{page page='managing-access-rights'}}) for precise steps.
...
2.  On the window **Available document types**, click on **BIRT Report**.
    ![]({{file name='birt-report-doc-type.png' space='nxdoc58' page='nuxeo-birt-integration'}} ?w=400,border=true)
...
*   on the report **Preview** tab: Only the parameters that are not set on the model or the report itself.
...
*   [Nuxeo - BIRT Integration dev documentation]({{page space='nxdoc58' page='nuxeo-birt-integration'}})
