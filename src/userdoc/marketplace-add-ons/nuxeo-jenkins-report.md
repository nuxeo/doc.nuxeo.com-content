...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/USERDOC58/Nuxeo+Jenkins+Report'
    page_id: '16092583'
    shortlink: p431
    shortlink_source: 'https://doc.nuxeo.com/x/p431'
    source_link: /display/USERDOC58/Nuxeo+Jenkins+Report
history:
    - 
        author: Solen Guitter
        date: '2016-08-30 14:48'
        message: ''
        version: '5'
    - 
        author: Solen Guitter
        date: '2013-12-23 10:47'
...
Jenkins Reports Containers can be created in workspaces and folders, by users who have at least Write rights.
...
You can now make a summary of the CI status in the Jenkins Duty Comment field. This uses the same editor as a [note]({{page page='notes'}}), which enables to add links to jobs and format your comment so it's easier to organize and read.
...
*   [Nuxeo Jenkins Report dev documentation]({{page space='nxdoc58' page='nuxeo-jenkins-report'}})
