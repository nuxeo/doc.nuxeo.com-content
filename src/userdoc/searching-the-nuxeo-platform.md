...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/USERDOC60/Searching+the+Nuxeo+Platform'
    page_id: '21299500'
    shortlink: LAFFAQ
    shortlink_source: 'https://doc.nuxeo.com/x/LAFFAQ'
    source_link: /display/USERDOC60/Searching+the+Nuxeo+Platform
tree_item_index: 400
history:
    -
        author: Anonymous
