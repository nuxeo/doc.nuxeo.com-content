...
![]({{file name='pdf-16.png' space='alldoc' page='nuxeo-downloadable-documentation'}} ?w=16,h=16) [Download this documentation in PDF]({{file name='Nuxeo_Platform_6.0_UserGuide.pdf' space='alldoc' page='nuxeo-downloadable-documentation'}})
