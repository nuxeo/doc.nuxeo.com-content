...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC58/Nuxeo+Shell'
    page_id: '16810075'
    shortlink: W4AAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/W4AAAQ'
    source_link: /display/ADMINDOC58/Nuxeo+Shell
history:
    - 
...
---
<div class="row"><div class="column medium-8"> {{#> callout type='info' heading='Availability Info'}}
...
The Nuxeo Shell is available at the Admin Center, in the "Monitor" tab and also as a WebEngine site at [http://host:port/nuxeo/site/shell](http://hostport).
...
See [Extending the Shell]({{page space='nxdoc58' page='extending-the-shell'}}) section for more details.
