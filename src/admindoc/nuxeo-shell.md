...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC60/Nuxeo+Shell'
    page_id: '21921906'
    shortlink: coBOAQ
...
history:
    -
        ...
        date: '2016-09-14 10:22'
        message: ''
        version: '39'
    -
        author: Solen Guitter
        date: '2015-09-29 11:48'
        message: ''
        version: '38'
    -
        author: Manon Lumeau
...
See [Extending the Shell]({{page space='nxdoc60' page='extending-the-shell'}}) section for more details.
