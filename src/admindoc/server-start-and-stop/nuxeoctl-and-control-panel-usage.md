...
</td></tr><tr><td colspan="1">`--clid`</td><td colspan="1">(Since Nuxeo 6.0) Use the provided instance CLID file</td></tr><tr><td colspan="1">`--ignore-missing`</td><td colspan="1">(Since Nuxeo 6.0) Ignore unknown packages on mp-add/install/set commands</td></tr></tbody></table>
