...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC58/nuxeoctl+and+Control+Panel+Usage
    page_id: '16809989'
    shortlink: BYAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/BYAAAQ'
    source_link: /display/ADMINDOC58/nuxeoctl+and+Control+Panel+Usage
history:
    - 
    ...
    - 
        ...
        message: Added location if nuxeoctl script
        version: '28'
    - 
        author: Solen Guitter
