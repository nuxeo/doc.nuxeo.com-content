...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC60/Registering+your+Nuxeo+Instance'
    page_id: '21921817'
    shortlink: GYBOAQ
...
2.  Click on the **Admin** tab.
    The **Nuxeo Connect** tab is displayed.
3.  Click on **Register this instance**.
...
3.  On the offline server:
    1.  In the Admin Center, fill in the instance description, paste the CLID from Nuxeo Connect and click on the **Register this instance** button.
