...
confluence:
    ...
    canonical: viewpage.action?pageId=16810084
    canonical_source: viewpage.action?pageId=16810084
    page_id: '16810084'
    shortlink: ZIAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/ZIAAAQ'
    source_link: /pages/viewpage.action?pageId=16810084
history:
    - 
    ...
    - 
        author: Solen Guitter
        date: '2014-01-24 10:28'
        message: Added script for SQL server and Oracle
        version: '6'
    - 
        author: Solen Guitter
