...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC58/Upgrade+from+5.1.2+to+5.1.3'
    page_id: '16810018'
    shortlink: IoAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/IoAAAQ'
    source_link: /display/ADMINDOC58/Upgrade+from+5.1.2+to+5.1.3
history:
    - 
...
Follow [Upgrade Nuxeo]({{page page='how-to-upgrade-nuxeo'}}) and apply the following procedure __before__ starting Nuxeo.
