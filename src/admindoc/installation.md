...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC58/Installation'
    page_id: '16810055'
    shortlink: R4AAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/R4AAAQ'
    source_link: /display/ADMINDOC58/Installation
history:
    - 
        author: Manon Lumeau
...
*   [Installing the Nuxeo Platform on Mac OS]({{page space='ADMINDOC58' page='Installing the+Nuxeo+Platform+on+Mac+OS'}})
*   [Installing the Nuxeo Platform on Windows]({{page space='ADMINDOC58' page='Installing the+Nuxeo+Platform+on+Windows'}})
    *   [Installing the Nuxeo Platform as a Windows Service]({{page space='ADMINDOC58' page='Installing the+Nuxeo+Platform+as+a+Windows+Service'}})
    *   [Running Multiple Server Instances in Windows]({{page space='ADMINDOC58' page='Running Multiple+Server+Instances+in+Windows'}})
*   [Installing the Nuxeo Platform on Linux]({{page space='ADMINDOC58' page='Installing the+Nuxeo+Platform+on+Linux'}})
    *   [Configuring the Nuxeo Platform as a Daemon on Debian]({{page space='ADMINDOC58' page='Configuring the+Nuxeo+Platform+as+a+Daemon+on+Debian'}})
*   [Deploying Nuxeo on Amazon AWS]({{page space='ADMINDOC58' page='Deploying Nuxeo+on+Amazon+AWS'}})
*   [Deploying Nuxeo on CloudFoundry]({{page space='ADMINDOC58' page='Deploying Nuxeo+on+CloudFoundry'}})
*   [How to Estimate Disk and Database Usage]({{page space='ADMINDOC58' page='How to+Estimate+Disk+and+Database+Usage'}})