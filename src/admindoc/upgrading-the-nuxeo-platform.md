...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC60/Upgrading+the+Nuxeo+Platform'
    page_id: '21921796'
    shortlink: BIBOAQ
...
2.  For each version of the upgrade path, build your custom plugin and check if it's running correctly once deployed in the Nuxeo Platform target version.
