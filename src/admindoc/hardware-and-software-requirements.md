...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC60/Hardware+and+Software+Requirements
    page_id: '21921868'
    shortlink: TIBOAQ
    shortlink_source: 'https://doc.nuxeo.com/x/TIBOAQ'
    source_link: /display/ADMINDOC60/Hardware+and+Software+Requirements
tree_item_index: 100
history:
    -
        author: Anonymous
...
2.  Type `java -version` and press **Enter**.
    ...
    {{#> panel type='code' heading='java -version result on Mac OS'}}
    ...
    {{/panel}}{{#> panel type='code' heading='java -version result on Ubuntu'}}
...
1.  Download it from the Oracle website ([Java 7](http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html) - [Java 8](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)) and choose the appropriate platform for your hardware and Windows version.
...
You can still download Java from the Oracle website ([Java 7](http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html) - [Java 8](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)).
...
*   Java 7: [Download](http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html) - [Instructions](http://www.java.com/en/download/help/mac_install.xml)
*   Java 8: [Download](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html) - [Instructions](http://docs.oracle.com/javase/8/docs/technotes/guides/install/mac_jdk.html)
...
{{! multiexcerpt name='known-working-configurations'}}
...
*   Linux
    *   <span class="im">Debian 7.0 Wheezy</span>
...
{{! multiexcerpt name='supported-directories'}}

*   OpenLDAP
*   OpenDS
*   Microsoft Active Directory

{{! /multiexcerpt}}{{! /multiexcerpt}}
