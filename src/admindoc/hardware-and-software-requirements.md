...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC58/Hardware+and+Software+Requirements
    page_id: '16810061'
    shortlink: TYAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/TYAAAQ'
    source_link: /display/ADMINDOC58/Hardware+and+Software+Requirements
history:
    - 
        author: Solen Guitter
        date: '2014-01-20 11:21'
        message: emoved note about Google Chrome Frame (not available in 5.8 anymore
        version: '49'
    - 
        author: Solen Guitter
        date: '2014-01-20 11:17'
...
1.  [Download it from the Oracle website](http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html) and choose the appropriate platform for your hardware and Windows version.
...
For Debian, it is not available in the current stable release (6.0.x aka "squeeze"), but it will be in the next one ("wheezy"). You can still [download it from the Oracle website](http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html), but in that case you can not use the nuxeo .deb package (the zip distribution still works fine).
...
Java 7 requires at least Lion (Mac OS 10.7.3). The Java 7 package for Mac OS is available [on the Oracle website](http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html) and instructions for installation [on the Java website](http://www.java.com/en/download/help/mac_install.xml).
