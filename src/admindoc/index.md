...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC60/Installation+and+Administration'
    page_id: '21921916'
    shortlink: fIBOAQ
    shortlink_source: 'https://doc.nuxeo.com/x/fIBOAQ'
    source_link: /display/ADMINDOC60/Installation+and+Administration
history:
    -
        author: Manon Lumeau
        date: '2016-07-20 16:04'
...
Welcome to the Installation and Administration Documentation!

{{/panel}}</div>
<div class="column medium-4">{{#> panel type='primary' no_markdown=true}}
...
*   [Hardware and Software Requirements]({{page space='ADMINDOC60' page='Hardware and+Software+Requirements'}})
*   [Installation]({{page space='ADMINDOC60' page='Installation'}})
*   [Setup]({{page space='ADMINDOC60' page='Setup'}})
*   [Server Start and Stop]({{page space='ADMINDOC60' page='Server Start+and+Stop'}})
*   [Monitoring and Maintenance]({{page space='ADMINDOC60' page='Monitoring and+Maintenance'}})
*   [Upgrading the Nuxeo Platform]({{page space='ADMINDOC60' page='Upgrading the+Nuxeo+Platform'}})
*   [Nuxeo Shell]({{page space='ADMINDOC60' page='Nuxeo Shell'}})
*   [Admin Tab Overview]({{page space='ADMINDOC60' page='Admin Tab+Overview'}})
*   [Troubleshooting]({{page space='ADMINDOC60' page='Troubleshooting'}})
