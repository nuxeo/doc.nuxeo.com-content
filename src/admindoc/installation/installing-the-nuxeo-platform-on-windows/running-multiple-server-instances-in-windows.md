...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC58/Running+Multiple+Server+Instances+in+Windows
    page_id: '16810089'
    shortlink: aYAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/aYAAAQ'
    source_link: /display/ADMINDOC58/Running+Multiple+Server+Instances+in+Windows
history:
    - 
...
*   `"nuxeo.conf"` file in the same location as the (real) NuxeoCtl.exe (for versions<5.4.1) or nuxeoctl.bat (for versions&ge;5.4.1).
