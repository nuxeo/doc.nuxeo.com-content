...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC58/Installing+the+Nuxeo+Platform+as+a+Windows+Service
    page_id: '16809997'
    shortlink: DYAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/DYAAAQ'
    source_link: /display/ADMINDOC58/Installing+the+Nuxeo+Platform+as+a+Windows+Service
history:
    - 
...
[YAJSW](http://yajsw.sourceforge.net/) is a Java centric implementation of the [Java Service Wrapper by tanuki](http://wrapper.tanukisoftware.org/) (JSW).
