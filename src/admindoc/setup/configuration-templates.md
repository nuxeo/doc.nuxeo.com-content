...
*   [https](https://doc.nuxeo.com/display/NXDOC/HTTP+and+HTTPS+Reverse-Proxy+Configuration): (not recommended) template to make the server listen to port 443 (HTTPS);
