...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC58/Recommended+Configurations'
    page_id: '16809998'
    shortlink: DoAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/DoAAAQ'
    source_link: /display/ADMINDOC58/Recommended+Configurations
history:
    - 
        author: Solen Guitter
        date: '2016-09-02 07:38'
        message: ''
        version: '21'
    - 
        author: Solen Guitter
        date: '2014-04-11 10:13'
        message: ''
        version: '20'
    - 
        author: Solen Guitter
...
The steps given below are given using the [Admin Center]({{page page='admin-center-overview'}}). They can of course also be done by [editing the `nuxeo.conf` file manually]({{page page='setup#manual-edit'}}).
...
The configuration of your application is saved in the `nuxeo.conf` configuration file, whatever the [means you use to configure your application]({{page page='setup'}}) (manual edit, Startup Wizard or Admin Center). It is better, although not mandatory, to store your customized configuration outside Nuxeo. This way, you will be able to easily upgrade Nuxeo, keeping your configuration safely apart of Nuxeo directory.
...
The Nuxeo Platform provides a default embedded database for testing and evaluation purpose, called Derby. However, it is not adapted for a production environment (see the [H2 limitations page]({{page space='nxdoc' page='h2-limitations'}})).

Before going live, you should configure one of the production-safe database supported by Nuxeo. See the [Database]({{page page='database'}}) section of this documentation.
