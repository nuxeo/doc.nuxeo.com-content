...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC710/Connecting+Nuxeo+to+the+Database
    page_id: '27604689'
    shortlink: 0TalAQ
...
## <a name="database-templates"></a>"Database Templates
...
### <a name="postgresql"></a>"postgresql (Recommended)
