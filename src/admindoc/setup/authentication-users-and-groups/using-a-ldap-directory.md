...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC60/Using+a+LDAP+Directory'
    page_id: '21921820'
    shortlink: HIBOAQ
...
For more details on directories, such as configuring "multi-directories", see [Data Lists and Directories]({{page space='nxdoc60' page='data-lists-and-directories'}}).
