...
history:
    - 
        ...
        message: hange title to have direct link on sectio
        version: '81'
    - 
        author: Manon Lumeau
...
## <a name="SettingupanElasticsearchCluster"></a>"Setting up an Elasticsearch Cluster
...
## <a name="ConfiguringNuxeoToAccessTheCluster"></a>"Configuring Nuxeo to Access the Cluster
...
### <a name="DisablingElasticsearchforAuditLogs"></a>"Disabling Elasticsearch for Audit Logs
...
## <a name="TriggeringSQLtoElasticsearchAuditLogsMigration"></a>"Triggering SQL to Elasticsearch Audit Logs Migration
...
## <a name="RebuildingtheIndex"></a>"Rebuilding the Repository Index
...
## <a name="changingElasticsearchMapping"></a>"Changing the Mappings and Settings of Indexes
