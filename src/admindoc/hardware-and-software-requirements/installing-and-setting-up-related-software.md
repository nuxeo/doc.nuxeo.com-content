...
confluence:
    ...
    canonical_source: >-
        https://doc.nuxeo.com/display/ADMINDOC60/Installing+and+Setting+up+Related+Software
    page_id: '21921854'
    shortlink: PoBOAQ
...
<a href="apt://openjdk-7-jdk,imagemagick,ufraw,poppler-utils,libreoffice,ffmpeg,libwpd-tools,ghostscript">sudo apt-get install openjdk-7-jdk imagemagick ufraw poppler-utils libreoffice ffmpeg libwpd-tools ghostscript</a>
...
Please note that you will need the [multiverse package repositories](https://help.ubuntu.com/community/Repositories/CommandLine) for this script to work.

## Installing on Mac OS

Most MAC OS installation instructions are provided using [Homebrew](http://mxcl.github.com/homebrew/) and [MacPorts](http://www.macports.org/).
...
2.  Edit the `Path` system variable and add `;IMAGEMAGICK_INSTALL_DIRECTORY` (`C:\Program Files (x86)\ImageMagick` for example).
    ...
    *   adding an environment variable:
        ...
        *   add an environment variable `MAGICK_THREAD_LIMIT` on Windows with value set to 1.{{/callout}}
