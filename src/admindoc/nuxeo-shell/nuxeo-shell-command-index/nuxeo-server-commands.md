...
confluence:
    ...
    canonical_source: 'https://doc.nuxeo.com/display/ADMINDOC58/Nuxeo+Server+Commands'
    page_id: '16810074'
    shortlink: WoAAAQ
    shortlink_source: 'https://doc.nuxeo.com/x/WoAAAQ'
    source_link: /display/ADMINDOC58/Nuxeo+Server+Commands
history:
    - 
